...
| 2026-03-28 | **v9.8.0** | **三币经济闭环**: 军粮消费道具 `ration_pack`（补给包📦 修复力20，25军粮）+ `inventory.ts` 新增 `supply` 类型 + `SHOP_PRICES` 接入 rations + `ShopPanel` 绿色卡片 + 底部提示更新；同时清理已完成遗留任务（Bundle拆分/SIMILAR_TRIANGLES已确认完成）| **212关, 2264 tests ✓** |
