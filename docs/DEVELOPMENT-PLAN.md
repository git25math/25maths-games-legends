...
- ✅ 428 个关卡（Y7 90 + Y8 78 + Y9 96 + Y10 89 + Y11 60 + Y12 15）
...
| 2026-03-30 | **v10.5.1** | **移动端 UX 打磨**: 顶部控件(语言切换+退出)3秒无操作自动收起为小圆点(opacity+scale 300ms过渡, hover/click展开) + 7个组件关闭/返回按钮扩大至44×44px最小触摸目标(VocabPopup/VocabReviewPanel/LearningTimeline/AssignmentPanel/RecoveryPathPanel) + BugReportButton手机端上移避开BottomNav + AchievementCard小屏安全边距 | **428关, 2414 tests ✓** |
