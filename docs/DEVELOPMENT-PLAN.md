...
- ✅ 210 个关卡（Y7 57 + Y8 40 + Y9 43 + Y10 40 + Y11 25 + Y12 5）
- ✅ 46 个题型 + 71 个活跃生成器类型 + 1,780 个 Vitest 用例
...
| 2026-03-29 | **v10.5.0** | **IGCSE KP 全量覆盖**: 128新关卡(300→428), KP覆盖287/288=99.7%, SINE_COSINE_RANDOM生成器, 91个discoverSteps, 51个MC多选生成器, 教学素材源自math-video-engine YAML脚本 | **428关, 2414 tests ✓** |
