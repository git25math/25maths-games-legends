    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-3 shrink-0">
          ...
          <button onClick={onClose} aria-label="Close" className="p-2 min-w-10 min-h-10 flex items-center justify-center text-white/60 hover:text-white transition-colors">
            <X size={22} />
          </button>
        </div>
