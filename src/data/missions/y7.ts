...
export const MISSIONS_Y7: Mission[] = [
  ...
  // --- Year 7 Unit 8: 排兵布阵·有序篇 (Topic 1.5 Ordering) ---
  {
    id: 774, grade: 7, unitId: 8, order: 1,
    unitTitle: { zh: 'Unit 8: 排兵布阵·有序篇', en: 'Unit 8: Formation Order' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '寒冬行军', en: 'Winter March' },
    skillName: { zh: '有向数术', en: 'Directed Numbers' },
    skillSummary: { zh: '正数=前进，负数=后退', en: 'Positive=forward, negative=backward' },
    story: { zh: '寒冬行军，气温从 $-3°C$ 又下降了 $5°C$。现在气温多少？', en: 'Winter march. Temperature drops from $-3°C$ by another $5°C$. What is it now?' },
    description: { zh: '计算 $-3 + (-5) = ?$', en: 'Calculate $-3 + (-5) = ?$' },
    data: { answer: -8 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-1.5-01', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '温度 $0°C$，先降 $3$ 度变成 $-3°C$。再降 $5$ 度，变成多少？', en: 'Temperature $0°C$, drops $3$ to $-3°C$. Drops $5$ more. What now?' },
      type: 'choice' as const,
      choices: [
        { zh: '$-8°C$（继续往负方向走5格）', en: '$-8°C$ (move 5 more in the negative direction)' },
        { zh: '$2°C$（$5 - 3$）', en: '$2°C$ ($5 - 3$)' },
      ],
      onCorrect: { zh: '对！$-3$ 再往负方向走 $5$ 格 → $-8$。\n数轴上，负数越往左越小。有向数=带方向的数字。', en: 'Right! $-3$ move $5$ more left → $-8$.\nOn a number line, further left = smaller. Directed numbers = numbers with direction.' },
      onWrong: { zh: '减法方向反了。$-3$ 已经在零下，再降 $5$ 是 $-3-5=-8$。', en: 'Direction reversed. $-3$ is already below zero, drop $5$ more = $-3-5=-8$.' },
      onSkip: { zh: '$-3 + (-5) = -8$。同号相加取相同号，绝对值相加。', en: '$-3 + (-5) = -8$. Same signs: add values, keep the sign.' },
    }],
    tutorialSteps: [
      { text: { zh: '刘备：为什么要学有向数？\n冬天行军，气温有正有负。"零下3度再降5度"不是 $3-5$，是 $-3+(-5)$。\n不懂有向数，连温度都算不对！', en: 'Liu Bei: "Why learn directed numbers?\nWinter marches have positive and negative temperatures. \'3 below zero, drop 5 more\' is $-3+(-5)$, not $3-5$.\nWithout directed numbers, you can\'t even calculate temperature!"' }, highlightField: 'ans' },
      { text: { zh: '刘备：有向数的规则\n同号相加：绝对值相加，保持原号\n$-3 + (-5)$：都是负，$3+5=8$，取负 → $-8$', en: 'Liu Bei: "Rules for directed numbers\nSame signs: add values, keep the sign\n$-3 + (-5)$: both negative, $3+5=8$, take negative → $-8$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：在数轴上看\n$-3$ 在零左边3格。再往左走5格 → 到 $-8$', en: 'Liu Bei: "On the number line\n$-3$ is 3 left of zero. Move 5 more left → $-8$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：计算\n$-3 + (-5) = -(3+5) = -8$', en: 'Liu Bei: "Calculate\n$-3 + (-5) = -(3+5) = -8$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：答案\n气温 $= -8°C$', en: 'Liu Bei: "Answer\nTemperature $= -8°C$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：验算\n$-8 + 5 = -3$ ✓ 回到了出发温度！', en: 'Liu Bei: "Verify\n$-8 + 5 = -3$ ✓ Back to the starting temperature!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '有向数：正数表示增加/前进，负数表示减少/后退。同号相加取同号。', en: 'Directed numbers: positive = increase, negative = decrease. Same signs: add values, keep sign.' }, formula: '$(-a)+(-b)=-(a+b)$', tips: [{ zh: '刘备提示：数轴是你的地图——左是负，右是正！', en: 'Liu Bei Tip: Number line is your map — left is negative, right is positive!' }] },
    storyConsequence: { correct: { zh: '寒冬行军——有向数精准！做得漂亮！', en: 'Winter March — directed numbers mastered!' }, wrong: { zh: '温度计算偏差——再看看正负方向？', en: 'Temperature miscalculated — check the direction?' } }
  },
  {
    id: 775, grade: 7, unitId: 8, order: 2,
    unitTitle: { zh: 'Unit 8: 排兵布阵·有序篇', en: 'Unit 8: Formation Order' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '粮草排序', en: 'Supply Ranking' },
    skillName: { zh: '排序术', en: 'Ordering' },
    skillSummary: { zh: '数轴上从小到大排列', en: 'Order numbers on a number line' },
    story: { zh: '五路粮草数量：$-5, 3, -1, 0, 7$。从小到大排列，中间那个（第3个）是哪个数？', en: 'Five supply counts: $-5, 3, -1, 0, 7$. Order smallest to largest — what is the 3rd number?' },
    description: { zh: '排列 $-5, 3, -1, 0, 7$，第3个是？', en: 'Order $-5, 3, -1, 0, 7$ smallest to largest. What is 3rd?' },
    data: { answer: 0 }, difficulty: 'Medium', reward: 40,
    kpId: 'kp-1.5-02', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '把 $-5, 3, -1, 0, 7$ 画在数轴上。最左边（最小）的是哪个？', en: 'Place $-5, 3, -1, 0, 7$ on a number line. Which is furthest left (smallest)?' },
      type: 'choice' as const,
      choices: [
        { zh: '$-5$（在数轴最左边）', en: '$-5$ (furthest left on number line)' },
        { zh: '$-1$（负数就是最小）', en: '$-1$ (negative means smallest)' },
      ],
      onCorrect: { zh: '没错！$-5$ 在数轴最左边，是最小的。\n从小到大：$-5, -1, 0, 3, 7$。第3个是 $0$。', en: 'Correct! $-5$ is furthest left, so it\'s the smallest.\nSmallest to largest: $-5, -1, 0, 3, 7$. The 3rd is $0$.' },
      onWrong: { zh: '$-1$ 确实是负数，但 $-5$ 更小（离零更远，在更左边）。\n排序：$-5, -1, 0, 3, 7$。第3个是 $0$。', en: '$-1$ is negative, but $-5$ is smaller (further from zero, further left).\nOrder: $-5, -1, 0, 3, 7$. The 3rd is $0$.' },
      onSkip: { zh: '数轴上越往左越小。排序：$-5, -1, 0, 3, 7$。中间第3个 = $0$。', en: 'Further left on number line = smaller. Order: $-5, -1, 0, 3, 7$. Middle (3rd) = $0$.' },
    }],
    tutorialSteps: [
      { text: { zh: '关羽：为什么排序很重要？\n五路粮草要按数量排队分配——不排好序，多的少的全搞混，后勤就乱套了！排序是数据处理的第一步。', en: 'Guan Yu: "Why is ordering important?\nFive supply routes need to be ranked by quantity — without ordering, logistics become chaos! Sorting is the first step of data processing."' }, highlightField: 'ans' },
      { text: { zh: '关羽：排序规则\n在数轴上：越往左越小，越往右越大。\n负数 < 零 < 正数\n负数比较：$-5 < -1$（离零越远越小）', en: 'Guan Yu: "Ordering rules\nOn the number line: further left = smaller, further right = larger.\nNegative < zero < positive\nComparing negatives: $-5 < -1$ (further from zero = smaller)"' }, highlightField: 'ans' },
      { text: { zh: '关羽：定位每个数\n$-5$：零左边5格\n$-1$：零左边1格\n$0$：原点\n$3$：零右边3格\n$7$：零右边7格', en: 'Guan Yu: "Locate each number\n$-5$: 5 left of zero\n$-1$: 1 left of zero\n$0$: origin\n$3$: 3 right of zero\n$7$: 7 right of zero"' }, highlightField: 'ans' },
      { text: { zh: '关羽：从小到大排列\n$$-5, -1, 0, 3, 7$$\n第1个=$-5$，第2个=$-1$，第3个=$0$，第4个=$3$，第5个=$7$', en: 'Guan Yu: "Smallest to largest\n$$-5, -1, 0, 3, 7$$\n1st=$-5$, 2nd=$-1$, 3rd=$0$, 4th=$3$, 5th=$7$"' }, highlightField: 'ans' },
      { text: { zh: '关羽：答案\n第3个数 $= 0$', en: 'Guan Yu: "Answer\nThe 3rd number $= 0$"' }, highlightField: 'ans' },
      { text: { zh: '关羽：验算\n$-5 < -1$ ✓（负数离零越远越小）\n$-1 < 0$ ✓\n$0 < 3$ ✓\n$3 < 7$ ✓\n排序正确！', en: 'Guan Yu: "Verify\n$-5 < -1$ ✓ (further from zero = smaller)\n$-1 < 0$ ✓\n$0 < 3$ ✓\n$3 < 7$ ✓\nOrdering confirmed!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '排序：在数轴上从左到右即从小到大。负数越大绝对值越小。', en: 'Ordering: left to right on number line = smallest to largest. Larger negative = closer to zero.' }, formula: '$a < b \\Leftrightarrow a \\text{ is left of } b \\text{ on number line}$', tips: [{ zh: '关羽提示：数轴是排序神器——画出来一目了然！', en: 'Guan Yu Tip: The number line is the ultimate sorting tool — draw it out!' }] },
    storyConsequence: { correct: { zh: '粮草排序井然有序！关羽：后勤调度完美！', en: 'Supply ranking perfect! Guan Yu: Logistics sorted!' }, wrong: { zh: '排序有误——再画画数轴？', en: 'Ordering off — try drawing a number line?' } }
  },
  {
    id: 776, grade: 7, unitId: 8, order: 3,
    unitTitle: { zh: 'Unit 8: 排兵布阵·有序篇', en: 'Unit 8: Formation Order' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '埋伏范围', en: 'Ambush Range' },
    skillName: { zh: '不等式整数解', en: 'Integer Solutions of Inequalities' },
    skillSummary: { zh: '找出范围内所有整数', en: 'Find all integers within a range' },
    story: { zh: '诸葛亮在数轴上标出埋伏范围：$-2 < x < 3$。这个范围内可以安排几个整数哨位？', en: 'Zhuge Liang marks the ambush range on a number line: $-2 < x < 3$. How many integer sentry posts fit?' },
    description: { zh: '$-2 < x < 3$，$x$ 可取几个整数值？', en: '$-2 < x < 3$, how many integer values can $x$ take?' },
    data: { answer: 4 }, difficulty: 'Medium', reward: 40,
    kpId: 'kp-1.5-03', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '$-2 < x < 3$，$x$ 能等于 $-2$ 吗？能等于 $3$ 吗？', en: '$-2 < x < 3$. Can $x$ equal $-2$? Can $x$ equal $3$?' },
      type: 'choice' as const,
      choices: [
        { zh: '都不能（严格不等号，不含端点）', en: 'Neither (strict inequality, endpoints excluded)' },
        { zh: '都能（在范围内）', en: 'Both (within range)' },
      ],
      onCorrect: { zh: '对！$<$ 是严格不等号，不包含端点。\n整数只有 $-1, 0, 1, 2$，共4个。', en: 'Right! $<$ is strict inequality, endpoints excluded.\nIntegers: $-1, 0, 1, 2$ — that\'s 4.' },
      onWrong: { zh: '注意符号！$<$ 不含等号，所以 $-2$ 和 $3$ 都不算。\n整数：$-1, 0, 1, 2$，共4个。', en: 'Watch the symbol! $<$ excludes equals, so $-2$ and $3$ don\'t count.\nIntegers: $-1, 0, 1, 2$ — that\'s 4.' },
      onSkip: { zh: '$-2 < x < 3$ 表示 $x$ 大于 $-2$ 且小于 $3$（不含端点）。\n整数解：$-1, 0, 1, 2$，共4个。', en: '$-2 < x < 3$ means $x$ is greater than $-2$ and less than $3$ (endpoints excluded).\nInteger solutions: $-1, 0, 1, 2$ — that\'s 4.' },
    }],
    tutorialSteps: [
      { text: { zh: '诸葛亮：为什么要找整数解？\n埋伏只能安排在整数位置（哨位不能放在"半格"上）。$-2 < x < 3$ 划出了范围，但哨兵只能站在整数点上——所以我们要数范围内有几个整数。', en: 'Zhuge Liang: "Why find integer solutions?\nAmbush posts can only be at integer positions (you can\'t place a sentry at \'half a grid\'). $-2 < x < 3$ defines the range, but sentries stand on integers — so count how many integers are inside."' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：严格不等号 vs 非严格\n$<$ 严格：不包含端点（空心圆）\n$\\leq$ 非严格：包含端点（实心圆）\n\n$-2 < x < 3$ → $x \\neq -2$ 且 $x \\neq 3$', en: 'Zhuge Liang: "Strict vs non-strict inequality\n$<$ strict: excludes endpoints (open circle)\n$\\leq$ non-strict: includes endpoints (filled circle)\n\n$-2 < x < 3$ → $x \\neq -2$ and $x \\neq 3$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：列出范围内的整数\n$-2$ 和 $3$ 不算（严格不等号）。\n$-2$ 右边第一个整数是 $-1$\n然后 $0, 1, 2$\n$3$ 不算！', en: 'Zhuge Liang: "List integers in range\n$-2$ and $3$ excluded (strict inequality).\nFirst integer right of $-2$ is $-1$\nThen $0, 1, 2$\n$3$ excluded!"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：计算\n整数解：$\\{-1, 0, 1, 2\\}$\n共 $4$ 个', en: 'Zhuge Liang: "Calculate\nInteger solutions: $\\{-1, 0, 1, 2\\}$\nTotal: $4$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n$x$ 可取 $4$ 个整数值。', en: 'Zhuge Liang: "Answer\n$x$ can take $4$ integer values."' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$-1$：$-2 < -1 < 3$ ✓\n$0$：$-2 < 0 < 3$ ✓\n$1$：$-2 < 1 < 3$ ✓\n$2$：$-2 < 2 < 3$ ✓\n全部满足！', en: 'Zhuge Liang: "Verify\n$-1$: $-2 < -1 < 3$ ✓\n$0$: $-2 < 0 < 3$ ✓\n$1$: $-2 < 1 < 3$ ✓\n$2$: $-2 < 2 < 3$ ✓\nAll valid!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '不等式整数解：先确定端点是否包含，再逐个列出范围内的整数。', en: 'Integer inequality solutions: check if endpoints are included, then list all integers within range.' }, formula: '$-2 < x < 3 \\Rightarrow x \\in \\{-1, 0, 1, 2\\}$', tips: [{ zh: '诸葛亮提示：严格不等号=空心圆=不含端点！', en: 'Zhuge Liang Tip: Strict inequality = open circle = endpoint excluded!' }] },
    storyConsequence: { correct: { zh: '埋伏范围精准——4个哨位一个不少！', en: 'Ambush range precise — all 4 sentry posts accounted for!' }, wrong: { zh: '哨位数算错了——注意端点是否包含？', en: 'Sentry count wrong — check if endpoints are included?' } }
  },
  // --- Year 7 Unit 9: 军中时辰·时间篇 (Topic 1.15 Time) ---
  {
    id: 777, grade: 7, unitId: 9, order: 1,
    unitTitle: { zh: 'Unit 9: 军中时辰·时间篇', en: 'Unit 9: Military Timekeeping' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '行军计时', en: 'March Timer' },
    skillName: { zh: '时间计算术', en: 'Time Calculations' },
    skillSummary: { zh: '跨小时的时间差计算', en: 'Calculate time differences across hours' },
    story: { zh: '大军09:15出发，12:30到达目的地。行军共用了多少分钟？', en: 'The army departs at 09:15 and arrives at 12:30. How many minutes was the march?' },
    description: { zh: '从09:15到12:30，共多少分钟？', en: 'From 09:15 to 12:30, how many minutes?' },
    data: { answer: 195 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-1.15-01', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '从09:15到12:15是整整3小时（180分钟）。但终点是12:30，还要再加多少分钟？', en: 'From 09:15 to 12:15 is exactly 3 hours (180 min). But arrival is 12:30 — how many more minutes?' },
      type: 'choice' as const,
      choices: [
        { zh: '再加15分钟，共195分钟', en: 'Add 15 more minutes, total 195 min' },
        { zh: '再加30分钟，共210分钟', en: 'Add 30 more minutes, total 210 min' },
      ],
      onCorrect: { zh: '对！09:15→12:15是180分钟，12:15→12:30再加15分钟。总共195分钟。', en: 'Right! 09:15→12:15 is 180 min, 12:15→12:30 adds 15 min. Total 195 min.' },
      onWrong: { zh: '注意：是从12:15到12:30，只差15分钟，不是30分钟。\n180+15=195分钟。', en: 'Note: 12:15 to 12:30 is only 15 minutes, not 30.\n180+15=195 minutes.' },
      onSkip: { zh: '分两段算：09:15→12:15=3小时=180分钟，12:15→12:30=15分钟。合计195分钟。', en: 'Split into two parts: 09:15→12:15=3 hours=180 min, 12:15→12:30=15 min. Total 195 min.' },
    }],
    tutorialSteps: [
      { text: { zh: '张飞：为什么行军要精确计时？\n粮草补给、援军汇合都有时限——差一刻钟可能错过战机！时间计算是行军调度的基本功。', en: 'Zhang Fei: "Why does marching need precise timing?\nSupply drops and reinforcement rendezvous have deadlines — 15 minutes late could miss the battle! Time calculation is essential for military logistics."' }, highlightField: 'ans' },
      { text: { zh: '张飞：时间计算技巧\n跨小时计算时，先算到整点，再加零头。\n或者：先对齐分钟数，算整小时差，再调整分钟差。', en: 'Zhang Fei: "Time calculation trick\nWhen crossing hours, first calculate to a round hour, then add the extra minutes.\nOr: align the minutes, find the hour difference, then adjust."' }, highlightField: 'ans' },
      { text: { zh: '张飞：方法一——分两段\n09:15 → 12:15 = 3小时 = 180分钟\n12:15 → 12:30 = 15分钟', en: 'Zhang Fei: "Method 1 — split into two parts\n09:15 → 12:15 = 3 hours = 180 minutes\n12:15 → 12:30 = 15 minutes"' }, highlightField: 'ans' },
      { text: { zh: '张飞：合计\n$180 + 15 = 195$ 分钟', en: 'Zhang Fei: "Total\n$180 + 15 = 195$ minutes"' }, highlightField: 'ans' },
      { text: { zh: '张飞：答案\n行军时间 $= 195$ 分钟（即3小时15分钟）', en: 'Zhang Fei: "Answer\nMarch time $= 195$ minutes (i.e. 3 hours 15 minutes)"' }, highlightField: 'ans' },
      { text: { zh: '张飞：验算\n09:15 + 195分钟 = 09:15 + 3小时15分 = 12:30 ✓', en: 'Zhang Fei: "Verify\n09:15 + 195 minutes = 09:15 + 3 hours 15 min = 12:30 ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '时间差计算：先算整小时差，再调整分钟差。1小时=60分钟。', en: 'Time difference: find hour difference first, then adjust minutes. 1 hour = 60 minutes.' }, formula: '$\\text{Time} = \\text{hours} \\times 60 + \\text{extra minutes}$', tips: [{ zh: '张飞提示：先对齐分钟再数小时，又快又准！', en: 'Zhang Fei Tip: Align minutes first, then count hours — fast and accurate!' }] },
    storyConsequence: { correct: { zh: '行军计时精准——195分钟一分不差！', en: 'March timer perfect — 195 minutes exactly!' }, wrong: { zh: '时间算差了——行军延误了！', en: 'Time calculation off — march delayed!' } }
  },
  {
    id: 778, grade: 7, unitId: 9, order: 2,
    unitTitle: { zh: 'Unit 9: 军中时辰·时间篇', en: 'Unit 9: Military Timekeeping' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '军令时刻', en: 'Military Orders Clock' },
    skillName: { zh: '12/24小时制', en: '12h/24h Clock' },
    skillSummary: { zh: '下午时段+12转24小时制', en: 'PM hours: add 12 for 24h format' },
    story: { zh: '军令传达用24小时制。下午5:30，换成24小时制是几点几分？（输入1730）', en: 'Military orders use 24h clock. 5:30 PM — what is it in 24h format? (Enter 1730)' },
    description: { zh: '下午5:30 → 24小时制？（输入如1730）', en: '5:30 PM → 24h format? (Enter e.g. 1730)' },
    data: { answer: 1730 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-1.15-02', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '12小时制的"下午5点"，在24小时制里是几点？\n提示：下午的小时数要加12。', en: '12h clock says "5 PM". What is it in 24h format?\nHint: for PM, add 12 to the hour.' },
      type: 'choice' as const,
      choices: [
        { zh: '17点（$5+12=17$）', en: '17 o\'clock ($5+12=17$)' },
        { zh: '5点（不用变）', en: '5 o\'clock (no change)' },
      ],
      onCorrect: { zh: '对！下午5点 = 17:00。所以下午5:30 = 17:30，输入1730。', en: 'Right! 5 PM = 17:00. So 5:30 PM = 17:30, enter 1730.' },
      onWrong: { zh: '24小时制下午要加12！5+12=17，所以下午5:30=17:30=1730。', en: '24h clock: PM hours add 12! 5+12=17, so 5:30 PM = 17:30 = 1730.' },
      onSkip: { zh: '24小时制规则：上午不变，下午+12。5 PM → 5+12=17 → 17:30 → 输入1730。', en: '24h rule: AM stays, PM adds 12. 5 PM → 5+12=17 → 17:30 → enter 1730.' },
    }],
    tutorialSteps: [
      { text: { zh: '赵云：为什么军队用24小时制？\n"5点集合"——是早上5点还是下午5点？战场上这种歧义可能致命！24小时制没有歧义：05:00是凌晨，17:00是傍晚。', en: 'Zhao Yun: "Why does the military use 24h clock?\n\'Meet at 5\' — 5 AM or 5 PM? On the battlefield, this ambiguity can be deadly! 24h clock is unambiguous: 05:00 is dawn, 17:00 is evening."' }, highlightField: 'ans' },
      { text: { zh: '赵云：转换规则\n上午（AM）：时间不变。01:00→01:00\n下午（PM）：小时+12。1PM→13:00, 5PM→17:00\n特殊：12PM=12:00（中午），12AM=00:00（午夜）', en: 'Zhao Yun: "Conversion rules\nAM: no change. 01:00→01:00\nPM: hour + 12. 1PM→13:00, 5PM→17:00\nSpecial: 12PM=12:00 (noon), 12AM=00:00 (midnight)"' }, highlightField: 'ans' },
      { text: { zh: '赵云：转换下午5:30\n小时：$5 + 12 = 17$\n分钟：$30$（不变）\n结果：$17:30$', en: 'Zhao Yun: "Convert 5:30 PM\nHour: $5 + 12 = 17$\nMinutes: $30$ (unchanged)\nResult: $17:30$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：写成数字\n$17:30$ → 输入 $1730$', en: 'Zhao Yun: "Write as number\n$17:30$ → enter $1730$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：答案\n下午5:30 $= 17:30$（24小时制）', en: 'Zhao Yun: "Answer\n5:30 PM $= 17:30$ (24h clock)"' }, highlightField: 'ans' },
      { text: { zh: '赵云：验算\n$17 - 12 = 5$（下午5点）✓\n分钟30不变 ✓\n$17:30$ = 下午5:30，正确！', en: 'Zhao Yun: "Verify\n$17 - 12 = 5$ (5 PM) ✓\nMinutes 30 unchanged ✓\n$17:30$ = 5:30 PM, correct!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '24小时制消除AM/PM歧义。下午小时+12，上午不变。', en: '24h clock removes AM/PM ambiguity. PM: add 12 to hour. AM: no change.' }, formula: '$\\text{PM hour} + 12 = \\text{24h hour}$', tips: [{ zh: '赵云提示：军令如山，时间不能有半点含糊！', en: 'Zhao Yun Tip: Military orders are absolute — time must be unambiguous!' }] },
    storyConsequence: { correct: { zh: '军令时刻——17:30精准传达！', en: 'Military Orders — 17:30 delivered precisely!' }, wrong: { zh: '时刻换算有误——军令可不能搞错！', en: 'Time conversion wrong — military orders can\'t be wrong!' } }
  },
  {
    id: 779, grade: 7, unitId: 9, order: 3,
    unitTitle: { zh: 'Unit 9: 军中时辰·时间篇', en: 'Unit 9: Military Timekeeping' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '跨境谍报', en: 'Cross-border Intelligence' },
    skillName: { zh: '时区计算术', en: 'Time Zone Calculation' },
    skillSummary: { zh: '东早西晚，相差几小时加减即可', en: 'East is ahead, west is behind. Add/subtract the difference.' },
    story: { zh: '北京时间20:00，要给伦敦的细作传信。伦敦比北京慢8小时，伦敦现在几点？', en: 'Beijing time is 20:00. Need to send message to a spy in London. London is 8 hours behind Beijing. What time is it in London?' },
    description: { zh: '北京20:00，伦敦慢8小时，伦敦几点？', en: 'Beijing 20:00, London is 8h behind. London time?' },
    data: { answer: 12 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-1.15-03', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '伦敦比北京"慢"8小时。"慢"意味着伦敦的时间比北京——', en: 'London is 8 hours "behind" Beijing. "Behind" means London\'s time is — than Beijing\'s.' },
      type: 'choice' as const,
      choices: [
        { zh: '更早（减8小时）', en: 'Earlier (subtract 8 hours)' },
        { zh: '更晚（加8小时）', en: 'Later (add 8 hours)' },
      ],
      onCorrect: { zh: '对！"慢"=时间更早=减去时差。$20-8=12$，伦敦是中午12点。', en: 'Right! "Behind" = earlier time = subtract. $20-8=12$, London is 12 noon.' },
      onWrong: { zh: '"慢8小时"说明伦敦还没到北京的时间，要减去。$20-8=12$。', en: '"8 hours behind" means London hasn\'t reached Beijing\'s time yet — subtract. $20-8=12$.' },
      onSkip: { zh: '慢=减。$20:00 - 8 = 12:00$。伦敦是中午12点。', en: 'Behind = subtract. $20:00 - 8 = 12:00$. London is 12 noon.' },
    }],
    tutorialSteps: [
      { text: { zh: '诸葛亮：为什么要懂时区？\n跨国谍报，发信时间搞错，细作可能在睡觉时被叫醒暴露身份！地球自转导致各地时间不同——东边的地方先看到太阳，时间更"快"。', en: 'Zhuge Liang: "Why understand time zones?\nCross-border intelligence — wrong timing could expose a spy! Earth\'s rotation means different places have different times — eastern locations see the sun first, so their time is \'ahead\'."' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：时区规则\n东边比西边"快"（时间更大）\n西边比东边"慢"（时间更小）\n\n北京在东，伦敦在西 → 伦敦比北京慢8小时', en: 'Zhuge Liang: "Time zone rules\nEast is \'ahead\' (later time)\nWest is \'behind\' (earlier time)\n\nBeijing is east, London is west → London is 8h behind Beijing"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：计算\n伦敦比北京慢 → 北京时间减去时差\n$20:00 - 8 = 12:00$', en: 'Zhuge Liang: "Calculate\nLondon is behind Beijing → subtract the difference\n$20:00 - 8 = 12:00$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：注意跨日\n如果北京是凌晨3:00，减8小时：$3-8=-5$\n这说明伦敦还在前一天的19:00（$24-5=19$）', en: 'Zhuge Liang: "Watch for day changes\nIf Beijing is 03:00, subtract 8: $3-8=-5$\nThis means London is still at 19:00 the previous day ($24-5=19$)"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n伦敦时间 $= 12:00$（中午12点）', en: 'Zhuge Liang: "Answer\nLondon time $= 12:00$ (12 noon)"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$12:00 + 8 = 20:00$（加回时差回到北京时间）✓', en: 'Zhuge Liang: "Verify\n$12:00 + 8 = 20:00$ (add back the difference to get Beijing time) ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '时区：东快西慢。往西=减时差，往东=加时差。注意跨日情况。', en: 'Time zones: east ahead, west behind. Going west = subtract, going east = add. Watch for day changes.' }, formula: '$\\text{Western time} = \\text{Eastern time} - \\text{difference}$', tips: [{ zh: '诸葛亮提示：时差搞反，细作暴露——东快西慢记牢了！', en: 'Zhuge Liang Tip: Get the time zone wrong and the spy is exposed — east ahead, west behind!' }] },
    storyConsequence: { correct: { zh: '跨境谍报——时区精准，信息安全送达！', en: 'Cross-border intelligence — time zone perfect, message delivered safely!' }, wrong: { zh: '时差算反了——细作差点暴露！', en: 'Time zone wrong — the spy was almost exposed!' } }
  },
  // --- Year 7 Unit 10: 军饷利息·货币篇 (Topic 1.16 Money) ---
  {
    id: 780, grade: 7, unitId: 10, order: 1,
    unitTitle: { zh: 'Unit 10: 军饷利息·货币篇', en: 'Unit 10: Military Treasury — Money' },
    topic: 'Algebra', type: 'PERCENTAGE',
    title: { zh: '军饷单利', en: 'Simple Interest Stipend' },
    skillName: { zh: '单利计算术', en: 'Simple Interest' },
    skillSummary: { zh: '利息 = 本金 x 利率 x 时间', en: 'Interest = Principal x Rate x Time' },
    story: { zh: '军饷本金1000金存入国库，年利率5%，存3年单利。总利息多少？', en: 'Military stipend of 1000 gold deposited in treasury at 5% annual rate, 3 years simple interest. Total interest?' },
    description: { zh: '本金1000，利率5%，3年单利，利息=？', en: 'Principal 1000, rate 5%, 3 years simple interest. Interest=?' },
    data: { answer: 150 }, difficulty: 'Easy', reward: 40,
    kpId: 'kp-1.16-01', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '单利的意思是：每年只对**本金**计算利息，不考虑之前赚的利息。\n1000金×5%=每年利息多少？', en: 'Simple interest means: interest is calculated on the **principal** only each year, ignoring previously earned interest.\n1000 gold × 5% = yearly interest?' },
      type: 'choice' as const,
      choices: [
        { zh: '每年50金（$1000 \\times 0.05$）', en: '50 gold per year ($1000 \\times 0.05$)' },
        { zh: '每年500金（$1000 \\times 5$）', en: '500 gold per year ($1000 \\times 5$)' },
      ],
      onCorrect: { zh: '对！每年50金，3年就是 $50 \\times 3 = 150$ 金。', en: 'Right! 50 gold per year, 3 years = $50 \\times 3 = 150$ gold.' },
      onWrong: { zh: '5% 要转成小数 0.05。$1000 \\times 0.05 = 50$，不是500。3年=$150$。', en: '5% as decimal is 0.05. $1000 \\times 0.05 = 50$, not 500. 3 years = $150$.' },
      onSkip: { zh: '单利公式：$I = P \\times r \\times t = 1000 \\times 0.05 \\times 3 = 150$ 金。', en: 'Simple interest: $I = P \\times r \\times t = 1000 \\times 0.05 \\times 3 = 150$ gold.' },
    }],
    tutorialSteps: [
      { text: { zh: '刘备：为什么要学利息？\n军饷存国库要计利息——单利是最简单的方式：每年只算本金的利息，不"利滚利"。这是所有金融计算的起点！', en: 'Liu Bei: "Why learn interest?\nMilitary funds in the treasury earn interest — simple interest is the easiest: each year calculates interest on the original principal only, no \'interest on interest\'. This is the starting point for all financial math!"' }, highlightField: 'ans' },
      { text: { zh: '刘备：单利公式\n$$I = P \\times r \\times t$$\n$I$=利息，$P$=本金，$r$=年利率（小数），$t$=时间（年）', en: 'Liu Bei: "Simple interest formula\n$$I = P \\times r \\times t$$\n$I$=interest, $P$=principal, $r$=annual rate (decimal), $t$=time (years)"' }, highlightField: 'ans' },
      { text: { zh: '刘备：代入数据\n$P = 1000$，$r = 5\\% = 0.05$，$t = 3$\n$$I = 1000 \\times 0.05 \\times 3$$', en: 'Liu Bei: "Substitute values\n$P = 1000$, $r = 5\\% = 0.05$, $t = 3$\n$$I = 1000 \\times 0.05 \\times 3$$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：计算\n$1000 \\times 0.05 = 50$（每年利息）\n$50 \\times 3 = 150$（三年总利息）', en: 'Liu Bei: "Calculate\n$1000 \\times 0.05 = 50$ (yearly interest)\n$50 \\times 3 = 150$ (total interest over 3 years)"' }, highlightField: 'ans' },
      { text: { zh: '刘备：答案\n总利息 $= 150$ 金', en: 'Liu Bei: "Answer\nTotal interest $= 150$ gold"' }, highlightField: 'ans' },
      { text: { zh: '刘备：验算\n每年50金 × 3年 = 150金\n本息合计：$1000 + 150 = 1150$ 金 ✓', en: 'Liu Bei: "Verify\n50 gold/year × 3 years = 150 gold\nTotal with principal: $1000 + 150 = 1150$ gold ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '单利：利息只按本金计算，每年利息相同。', en: 'Simple interest: calculated on principal only, same interest each year.' }, formula: '$I = P \\times r \\times t$', tips: [{ zh: '刘备提示：百分比先变小数！5%=0.05，别忘了除以100！', en: 'Liu Bei Tip: Convert percentage to decimal first! 5% = 0.05, don\'t forget to divide by 100!' }] },
    storyConsequence: { correct: { zh: '军饷单利——150金精准到账！', en: 'Simple interest — 150 gold calculated perfectly!' }, wrong: { zh: '利息算错了——国库账目可不能有差！', en: 'Interest wrong — treasury books must be accurate!' } }
  },
  {
    id: 781, grade: 7, unitId: 10, order: 2,
    unitTitle: { zh: 'Unit 10: 军饷利息·货币篇', en: 'Unit 10: Military Treasury — Money' },
    topic: 'Algebra', type: 'PERCENTAGE',
    title: { zh: '复利增值', en: 'Compound Growth' },
    skillName: { zh: '复利计算术', en: 'Compound Interest' },
    skillSummary: { zh: '本息合计 = 本金 x (1+利率)^年数', en: 'Total = Principal x (1+rate)^years' },
    story: { zh: '国库1000金，年利率10%，复利存2年。2年后本息合计多少？', en: 'Treasury has 1000 gold at 10% annual rate, compounded for 2 years. Total after 2 years?' },
    description: { zh: '本金1000，利率10%，复利2年，本息合计=？', en: 'Principal 1000, rate 10%, compound 2 years. Total=?' },
    data: { answer: 1210 }, difficulty: 'Medium', reward: 50,
    kpId: 'kp-1.16-02', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '复利和单利的区别：复利会把第一年赚的利息也加入本金，第二年"利滚利"。\n第一年：$1000 \\times 1.1 = 1100$。第二年的本金变成了？', en: 'Compound vs simple: compound adds first year\'s interest to principal for the second year.\nYear 1: $1000 \\times 1.1 = 1100$. What is Year 2\'s principal?' },
      type: 'choice' as const,
      choices: [
        { zh: '1100金（第一年的本息成为新本金）', en: '1100 gold (Year 1 total becomes new principal)' },
        { zh: '还是1000金（本金不变）', en: 'Still 1000 gold (principal unchanged)' },
      ],
      onCorrect: { zh: '对！复利的关键就是"利滚利"。$1100 \\times 1.1 = 1210$ 金。', en: 'Right! Compound interest means "interest on interest". $1100 \\times 1.1 = 1210$ gold.' },
      onWrong: { zh: '那是单利。复利的本金会变！第二年用1100，$1100 \\times 1.1 = 1210$。', en: 'That\'s simple interest. Compound changes the principal! Year 2 uses 1100, $1100 \\times 1.1 = 1210$.' },
      onSkip: { zh: '复利：$1000 \\times 1.1 = 1100$（第1年），$1100 \\times 1.1 = 1210$（第2年）。', en: 'Compound: $1000 \\times 1.1 = 1100$ (Year 1), $1100 \\times 1.1 = 1210$ (Year 2).' },
    }],
    tutorialSteps: [
      { text: { zh: '诸葛亮：复利为什么比单利多？\n单利每年只算1000的10%=100。复利第二年算的是1100的10%=110——多了10金！这就是"利滚利"的威力。年数越多差距越大！', en: 'Zhuge Liang: "Why is compound more than simple?\nSimple: 10% of 1000 = 100 each year. Compound: Year 2 calculates 10% of 1100 = 110 — 10 more gold! That\'s the power of \'interest on interest\'. The gap grows with more years!"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：复利公式\n$$A = P \\times (1 + r)^t$$\n$A$=本息合计，$P$=本金，$r$=利率（小数），$t$=年数', en: 'Zhuge Liang: "Compound interest formula\n$$A = P \\times (1 + r)^t$$\n$A$=total amount, $P$=principal, $r$=rate (decimal), $t$=years"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：逐年计算\n第1年：$1000 \\times 1.1 = 1100$\n第2年：$1100 \\times 1.1 = 1210$', en: 'Zhuge Liang: "Year by year\nYear 1: $1000 \\times 1.1 = 1100$\nYear 2: $1100 \\times 1.1 = 1210$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：或用公式一步到位\n$A = 1000 \\times (1.1)^2 = 1000 \\times 1.21 = 1210$', en: 'Zhuge Liang: "Or use the formula directly\n$A = 1000 \\times (1.1)^2 = 1000 \\times 1.21 = 1210$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n本息合计 $= 1210$ 金\n（比单利多 $1210 - 1200 = 10$ 金）', en: 'Zhuge Liang: "Answer\nTotal amount $= 1210$ gold\n(10 gold more than simple interest: $1210 - 1200 = 10$)"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$1000 \\times 1.1 = 1100$ ✓\n$1100 \\times 1.1 = 1210$ ✓\n利息总额：$1210 - 1000 = 210$ 金', en: 'Zhuge Liang: "Verify\n$1000 \\times 1.1 = 1100$ ✓\n$1100 \\times 1.1 = 1210$ ✓\nTotal interest: $1210 - 1000 = 210$ gold"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '复利：每期利息加入本金，下期"利滚利"。时间越长，复利威力越大。', en: 'Compound interest: each period\'s interest is added to principal. Longer time = greater compound effect.' }, formula: '$A = P \\times (1+r)^t$', tips: [{ zh: '诸葛亮提示：复利是世界第八大奇迹——时间就是金钱！', en: 'Zhuge Liang Tip: Compound interest is the 8th wonder — time is money!' }] },
    storyConsequence: { correct: { zh: '复利增值——1210金精准计算！', en: 'Compound growth — 1210 gold calculated perfectly!' }, wrong: { zh: '利滚利算错了——国库吃亏了！', en: 'Compound calculation wrong — treasury loses out!' } }
  },
  // --- Year 7 Unit 11: 度量衡·单位篇 (Topic 5.1 Units) ---
  {
    id: 782, grade: 7, unitId: 11, order: 1,
    unitTitle: { zh: 'Unit 11: 度量衡·单位篇', en: 'Unit 11: Weights & Measures — Units' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '丈量疆土', en: 'Measuring Territory' },
    skillName: { zh: '基本单位换算', en: 'Basic Unit Conversion' },
    skillSummary: { zh: '公里↔米，1km=1000m', en: 'km to m: 1km = 1000m' },
    story: { zh: '赵云巡边报告：边境线长5公里。换成米是多少？', en: 'Zhao Yun\'s patrol report: border is 5 km long. How many metres is that?' },
    description: { zh: '5公里 = ?米', en: '5 km = ? metres' },
    data: { answer: 5000 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-5.1-01', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '1公里=1000米。那5公里等于多少米？', en: '1 km = 1000 m. So 5 km = ? m.' },
      type: 'choice' as const,
      choices: [
        { zh: '5000米（$5 \\times 1000$）', en: '5000 m ($5 \\times 1000$)' },
        { zh: '500米（$5 \\times 100$）', en: '500 m ($5 \\times 100$)' },
      ],
      onCorrect: { zh: '对！大单位→小单位要乘。$5 \\times 1000 = 5000$ 米。', en: 'Right! Larger to smaller unit: multiply. $5 \\times 1000 = 5000$ m.' },
      onWrong: { zh: '1公里=1000米，不是100米。$5 \\times 1000 = 5000$ 米。', en: '1 km = 1000 m, not 100 m. $5 \\times 1000 = 5000$ m.' },
      onSkip: { zh: '$5 \\text{ km} = 5 \\times 1000 = 5000$ 米。大单位变小单位，乘以换算比。', en: '$5 \\text{ km} = 5 \\times 1000 = 5000$ m. Larger to smaller: multiply by the conversion factor.' },
    }],
    tutorialSteps: [
      { text: { zh: '赵云：为什么要学单位换算？\n巡边报告说"5公里"，可是画地图要用米，修城墙要用厘米——同一个距离，不同场景用不同单位。不会换算，图纸全乱！', en: 'Zhao Yun: "Why learn unit conversion?\nPatrol report says \'5 km\', but maps use metres, builders use centimetres — same distance, different units for different tasks. Without conversion, blueprints are useless!"' }, highlightField: 'ans' },
      { text: { zh: '赵云：长度单位阶梯\n$$\\text{km} \\xrightarrow{\\times 1000} \\text{m} \\xrightarrow{\\times 100} \\text{cm} \\xrightarrow{\\times 10} \\text{mm}$$\n大→小：乘。小→大：除。', en: 'Zhao Yun: "Length unit ladder\n$$\\text{km} \\xrightarrow{\\times 1000} \\text{m} \\xrightarrow{\\times 100} \\text{cm} \\xrightarrow{\\times 10} \\text{mm}$$\nLarger→smaller: multiply. Smaller→larger: divide."' }, highlightField: 'ans' },
      { text: { zh: '赵云：代入\n$5 \\text{ km} \\to \\text{m}$\n大单位→小单位 → 乘以1000', en: 'Zhao Yun: "Substitute\n$5 \\text{ km} \\to \\text{m}$\nLarger→smaller → multiply by 1000"' }, highlightField: 'ans' },
      { text: { zh: '赵云：计算\n$$5 \\times 1000 = 5000 \\text{ m}$$', en: 'Zhao Yun: "Calculate\n$$5 \\times 1000 = 5000 \\text{ m}$$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：答案\n$5$ 公里 $= 5000$ 米', en: 'Zhao Yun: "Answer\n$5$ km $= 5000$ m"' }, highlightField: 'ans' },
      { text: { zh: '赵云：验算\n$5000 \\div 1000 = 5$ km ✓ 反向换算回去没问题！', en: 'Zhao Yun: "Verify\n$5000 \\div 1000 = 5$ km ✓ Reverse conversion checks out!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '单位换算：大→小乘，小→大除。记住换算比即可。', en: 'Unit conversion: larger→smaller multiply, smaller→larger divide. Just remember the conversion factor.' }, formula: '$1 \\text{ km} = 1000 \\text{ m}$', tips: [{ zh: '赵云提示：大变小要乘——想象把一个大饼切成很多小块，数量变多了！', en: 'Zhao Yun Tip: Larger to smaller means multiply — imagine cutting a big cake into many small pieces!' }] },
    storyConsequence: { correct: { zh: '丈量疆土——5000米精准无误！', en: 'Territory measured — 5000 m exactly right!' }, wrong: { zh: '单位换算出错——地图比例失真了！', en: 'Conversion wrong — map scale is off!' } }
  },
  {
    id: 783, grade: 7, unitId: 11, order: 2,
    unitTitle: { zh: 'Unit 11: 度量衡·单位篇', en: 'Unit 11: Weights & Measures — Units' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '粮秣称重', en: 'Weighing Supplies' },
    skillName: { zh: '公制质量换算', en: 'Metric Mass Conversion' },
    skillSummary: { zh: '千克↔克，1kg=1000g', en: 'kg to g: 1kg = 1000g' },
    story: { zh: '粮官报告：今日配给3.5千克大米。换成克是多少？', en: 'Supply officer reports: today\'s ration is 3.5 kg of rice. How many grams?' },
    description: { zh: '3.5千克 = ?克', en: '3.5 kg = ? grams' },
    data: { answer: 3500 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-5.1-02', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '1千克=1000克。3.5千克=?', en: '1 kg = 1000 g. 3.5 kg = ?' },
      type: 'choice' as const,
      choices: [
        { zh: '3500克（$3.5 \\times 1000$）', en: '3500 g ($3.5 \\times 1000$)' },
        { zh: '350克（$3.5 \\times 100$）', en: '350 g ($3.5 \\times 100$)' },
      ],
      onCorrect: { zh: '对！$3.5 \\times 1000 = 3500$ 克。千克→克，乘1000。', en: 'Right! $3.5 \\times 1000 = 3500$ g. kg→g, multiply by 1000.' },
      onWrong: { zh: '千克到克是乘1000，不是100。$3.5 \\times 1000 = 3500$。', en: 'kg to g is ×1000, not ×100. $3.5 \\times 1000 = 3500$.' },
      onSkip: { zh: '$3.5 \\text{ kg} = 3.5 \\times 1000 = 3500$ 克。', en: '$3.5 \\text{ kg} = 3.5 \\times 1000 = 3500$ g.' },
    }],
    tutorialSteps: [
      { text: { zh: '关羽：为什么质量换算很重要？\n粮草分配精确到克——3.5千克听起来不多，但那是3500克！战时每一粒粮食都珍贵，称重换算不能出错。', en: 'Guan Yu: "Why is mass conversion important?\nRations must be precise to the gram — 3.5 kg sounds modest, but that\'s 3500 g! In wartime every grain counts, weighing must be accurate."' }, highlightField: 'ans' },
      { text: { zh: '关羽：质量单位阶梯\n$$\\text{t} \\xrightarrow{\\times 1000} \\text{kg} \\xrightarrow{\\times 1000} \\text{g} \\xrightarrow{\\times 1000} \\text{mg}$$\n每一级都是1000倍！', en: 'Guan Yu: "Mass unit ladder\n$$\\text{t} \\xrightarrow{\\times 1000} \\text{kg} \\xrightarrow{\\times 1000} \\text{g} \\xrightarrow{\\times 1000} \\text{mg}$$\nEach step is ×1000!"' }, highlightField: 'ans' },
      { text: { zh: '关羽：代入\n$3.5 \\text{ kg} \\to \\text{g}$\n大单位→小单位 → 乘1000', en: 'Guan Yu: "Substitute\n$3.5 \\text{ kg} \\to \\text{g}$\nLarger→smaller → multiply by 1000"' }, highlightField: 'ans' },
      { text: { zh: '关羽：计算\n$3.5 \\times 1000 = 3500$\n技巧：乘1000就是小数点右移3位', en: 'Guan Yu: "Calculate\n$3.5 \\times 1000 = 3500$\nTrick: ×1000 means move decimal point 3 places right"' }, highlightField: 'ans' },
      { text: { zh: '关羽：答案\n$3.5$ 千克 $= 3500$ 克', en: 'Guan Yu: "Answer\n$3.5$ kg $= 3500$ g"' }, highlightField: 'ans' },
      { text: { zh: '关羽：验算\n$3500 \\div 1000 = 3.5$ kg ✓ 反向换算正确！', en: 'Guan Yu: "Verify\n$3500 \\div 1000 = 3.5$ kg ✓ Reverse conversion checks out!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '质量换算：kg→g乘1000。乘1000=小数点右移3位。', en: 'Mass conversion: kg→g multiply by 1000. ×1000 = move decimal 3 places right.' }, formula: '$1 \\text{ kg} = 1000 \\text{ g}$', tips: [{ zh: '关羽提示：乘1000就是移小数点三位——又快又准！', en: 'Guan Yu Tip: ×1000 = move decimal 3 places — fast and accurate!' }] },
    storyConsequence: { correct: { zh: '粮秣称重——3500克精准无误！', en: 'Supplies weighed — 3500 g exactly right!' }, wrong: { zh: '称重换算出错——粮草分配不均了！', en: 'Weighing wrong — rations unevenly distributed!' } }
  },
  {
    id: 784, grade: 7, unitId: 11, order: 3,
    unitTitle: { zh: 'Unit 11: 度量衡·单位篇', en: 'Unit 11: Weights & Measures — Units' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '营帐面积', en: 'Camp Area' },
    skillName: { zh: '面积单位换算', en: 'Area Unit Conversion' },
    skillSummary: { zh: '面积换算要平方：1m=100cm → 1m²=10000cm²', en: 'Area conversion squares the factor: 1m=100cm → 1m²=10000cm²' },
    story: { zh: '营帐占地2平方米。换成平方厘米是多少？（提示：$1\\text{m}=100\\text{cm}$）', en: 'Camp tent covers 2 square metres. How many square centimetres? (Hint: $1\\text{m}=100\\text{cm}$)' },
    description: { zh: '$2\\text{m}^2 = ?\\text{cm}^2$', en: '$2\\text{m}^2 = ?\\text{cm}^2$' },
    data: { answer: 20000 }, difficulty: 'Medium', reward: 50,
    kpId: 'kp-5.1-03', sectionId: 'number',
    discoverSteps: [{
      prompt: { zh: '长度：$1\\text{m} = 100\\text{cm}$。\n但面积是二维的！$1\\text{m}^2 = 1\\text{m} \\times 1\\text{m}$。\n换成厘米：$100\\text{cm} \\times 100\\text{cm} = ?$', en: 'Length: $1\\text{m} = 100\\text{cm}$.\nBut area is 2D! $1\\text{m}^2 = 1\\text{m} \\times 1\\text{m}$.\nIn cm: $100\\text{cm} \\times 100\\text{cm} = ?$' },
      type: 'choice' as const,
      choices: [
        { zh: '$10000\\text{cm}^2$（$100 \\times 100$）', en: '$10000\\text{cm}^2$ ($100 \\times 100$)' },
        { zh: '$100\\text{cm}^2$（直接换）', en: '$100\\text{cm}^2$ (direct conversion)' },
      ],
      onCorrect: { zh: '对！面积换算要平方！$1\\text{m}^2 = 10000\\text{cm}^2$。所以 $2\\text{m}^2 = 20000\\text{cm}^2$。', en: 'Right! Area conversion squares the factor! $1\\text{m}^2 = 10000\\text{cm}^2$. So $2\\text{m}^2 = 20000\\text{cm}^2$.' },
      onWrong: { zh: '面积不能直接套长度换算比！$1\\text{m}^2 = 100 \\times 100 = 10000\\text{cm}^2$。\n$2\\text{m}^2 = 20000\\text{cm}^2$。', en: 'Area can\'t use the length conversion directly! $1\\text{m}^2 = 100 \\times 100 = 10000\\text{cm}^2$.\n$2\\text{m}^2 = 20000\\text{cm}^2$.' },
      onSkip: { zh: '面积=长×宽，两个维度都要换。$1\\text{m}^2 = 100^2 = 10000\\text{cm}^2$。$2 \\times 10000 = 20000$。', en: 'Area = length × width, both dimensions convert. $1\\text{m}^2 = 100^2 = 10000\\text{cm}^2$. $2 \\times 10000 = 20000$.' },
    }],
    tutorialSteps: [
      { text: { zh: '张飞：面积换算为什么跟长度不一样？\n长度是一维（线），面积是二维（面）。1米=100厘米没错，但1平方米是一个边长1米的正方形——换成厘米就是100×100=10000平方厘米！不是100！', en: 'Zhang Fei: "Why is area conversion different from length?\nLength is 1D (a line), area is 2D (a surface). 1m = 100cm is correct, but 1 square metre is a square with side 1m — in cm that\'s 100×100 = 10000 cm²! Not 100!"' }, highlightField: 'ans' },
      { text: { zh: '张飞：面积换算规则\n长度比 × 长度比 = 面积比\n$1\\text{m} = 100\\text{cm}$\n$1\\text{m}^2 = 100^2 = 10000\\text{cm}^2$', en: 'Zhang Fei: "Area conversion rule\nLength ratio × length ratio = area ratio\n$1\\text{m} = 100\\text{cm}$\n$1\\text{m}^2 = 100^2 = 10000\\text{cm}^2$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：代入\n$2\\text{m}^2 \\to \\text{cm}^2$\n$2 \\times 10000$', en: 'Zhang Fei: "Substitute\n$2\\text{m}^2 \\to \\text{cm}^2$\n$2 \\times 10000$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：计算\n$$2 \\times 10000 = 20000 \\text{ cm}^2$$', en: 'Zhang Fei: "Calculate\n$$2 \\times 10000 = 20000 \\text{ cm}^2$$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：答案\n$2\\text{m}^2 = 20000\\text{cm}^2$', en: 'Zhang Fei: "Answer\n$2\\text{m}^2 = 20000\\text{cm}^2$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：验算\n$20000 \\div 10000 = 2\\text{m}^2$ ✓\n或者想象：一个 $100\\text{cm} \\times 200\\text{cm}$ 的长方形 = $20000\\text{cm}^2$ = $1\\text{m} \\times 2\\text{m}$ = $2\\text{m}^2$ ✓', en: 'Zhang Fei: "Verify\n$20000 \\div 10000 = 2\\text{m}^2$ ✓\nOr imagine: a $100\\text{cm} \\times 200\\text{cm}$ rectangle = $20000\\text{cm}^2$ = $1\\text{m} \\times 2\\text{m}$ = $2\\text{m}^2$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '面积换算要把长度换算比平方！体积则是立方。这是最常见的易错点。', en: 'Area conversion: square the length factor! Volume: cube it. This is the most common mistake.' }, formula: '$1\\text{m}^2 = (100)^2\\text{cm}^2 = 10000\\text{cm}^2$', tips: [{ zh: '张飞提示：面积=二维=换算比要平方！体积=三维=立方！', en: 'Zhang Fei Tip: Area = 2D = square the factor! Volume = 3D = cube it!' }] },
    storyConsequence: { correct: { zh: '营帐面积精准——20000平方厘米一分不差！', en: 'Camp area precise — 20000 cm² exactly right!' }, wrong: { zh: '面积换算出错——营帐大小搞错了！', en: 'Area conversion wrong — camp size miscalculated!' } }
  },
  // --- Year 7 Unit 12: 数的类型进阶 (Topic 1.1 continued) ---
  {
    id: 785, grade: 7, unitId: 12, order: 1,
    unitTitle: { zh: 'Unit 12: 数的类型进阶', en: 'Unit 12: Advanced Number Types' },
    topic: 'Algebra', type: 'SQUARE_CUBE',
    title: { zh: '方阵点兵', en: 'Square Formation Drill' },
    discoverSteps: [{
      prompt: { zh: '1, 4, 9, 16, 25... 看出规律了吗？\n$1=1^2$, $4=2^2$, $9=3^2$...\n\n1000 属于这个队列吗？', en: '1, 4, 9, 16, 25... see the pattern?\n$1=1^2$, $4=2^2$, $9=3^2$...\n\nDoes 1000 belong in this sequence?' },
      type: 'choice' as const,
      choices: [
        { zh: '不属于——$31^2=961$, $32^2=1024$，跳过了1000', en: 'No — $31^2=961$, $32^2=1024$, skips 1000' },
        { zh: '属于——1000是某个数的平方', en: 'Yes — 1000 is a perfect square' },
      ],
      onCorrect: { zh: '没错！$31^2=961$, $32^2=1024$——1000卡在中间，不是完全平方数。平方数只能是整数的平方！', en: 'Exactly! $31^2=961$, $32^2=1024$ — 1000 falls in between, not a perfect square. Square numbers must be exact squares of integers!' },
      onWrong: { zh: '来验证：$31^2=961$, $32^2=1024$。1000在961和1024之间——没有整数的平方等于1000。', en: 'Let\'s check: $31^2=961$, $32^2=1024$. 1000 is between them — no integer squared gives 1000.' },
      onSkip: { zh: '平方数：$1^2=1, 2^2=4, 3^2=9...$\n$31^2=961, 32^2=1024$。1000不是任何整数的平方，所以不属于。', en: 'Square numbers: $1^2=1, 2^2=4, 3^2=9...$\n$31^2=961, 32^2=1024$. 1000 is not any integer squared, so it doesn\'t belong.' },
    }],
    skillName: { zh: '平方与立方数', en: 'Square & Cube Numbers' },
    skillSummary: { zh: '平方数=整数×自己，立方数=整数×自己×自己', en: 'Square = integer × itself, cube = integer × itself × itself' },
    story: { zh: '刘备要把士兵排成正方形方阵。$7$ 排 $7$ 列——共多少人？', en: 'Liu Bei arranges soldiers in a square formation. $7$ rows by $7$ columns — how many soldiers?' },
    description: { zh: '$7^2 = ?$', en: '$7^2 = ?$' },
    data: { base: 7, power: 2, answer: 49, generatorType: 'SQUARE_CUBE_RANDOM' }, difficulty: 'Easy', reward: 35,
    kpId: 'kp-1.1-03', sectionId: 'number',
    tutorialSteps: [
      { text: { zh: '刘备：为什么要学平方数？\n排兵布阵需要正方形方阵——$7$ 排 $7$ 列，就是 $7 \\times 7$。这个结果叫"$7$ 的平方"，写成 $7^2$。平方数在面积、距离公式中到处出现！', en: 'Liu Bei: "Why learn square numbers?\nSquare formations need equal rows and columns — 7 rows by 7 columns is $7 \\times 7$. This result is called \'7 squared\', written $7^2$. Square numbers appear everywhere in area and distance formulas!"' }, highlightField: 'ans' },
      { text: { zh: '刘备：平方数的定义\n$$n^2 = n \\times n$$\n$1^2=1, 2^2=4, 3^2=9, 4^2=16, 5^2=25...$\n\n立方数：$n^3 = n \\times n \\times n$（三维方阵）', en: 'Liu Bei: "Definition of square numbers\n$$n^2 = n \\times n$$\n$1^2=1, 2^2=4, 3^2=9, 4^2=16, 5^2=25...$\n\nCube numbers: $n^3 = n \\times n \\times n$ (3D formation)"' }, highlightField: 'ans' },
      { text: { zh: '刘备：计算 $7^2$\n$$7^2 = 7 \\times 7$$', en: 'Liu Bei: "Calculate $7^2$\n$$7^2 = 7 \\times 7$$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：逐步乘\n$7 \\times 7 = 49$', en: 'Liu Bei: "Step by step\n$7 \\times 7 = 49$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：答案\n$$7^2 = 49$$\n方阵共 $49$ 名士兵。', en: 'Liu Bei: "Answer\n$$7^2 = 49$$\n49 soldiers in the square formation."' }, highlightField: 'ans' },
      { text: { zh: '刘备：验算\n$\\sqrt{49} = 7$ ✓\n49确实是完全平方数，$7 \\times 7 = 49$。', en: 'Liu Bei: "Verify\n$\\sqrt{49} = 7$ ✓\n49 is indeed a perfect square, $7 \\times 7 = 49$."' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '平方数是整数乘以自身，立方数是整数乘以自身三次。它们是几何中面积和体积的基础。', en: 'Square numbers are integers multiplied by themselves; cube numbers multiply by themselves three times. They form the basis of area and volume in geometry.' }, formula: { zh: '$n^2 = n \\times n$；$n^3 = n \\times n \\times n$', en: '$n^2 = n \\times n$; $n^3 = n \\times n \\times n$' }, tips: [{ zh: '刘备提示：记住前15个平方数——考试常考！', en: 'Liu Bei Tip: Memorise the first 15 square numbers — they come up often in exams!' }] },
    storyConsequence: { correct: { zh: '方阵点兵——49人整齐列阵！', en: 'Square formation — 49 soldiers perfectly arranged!' }, wrong: { zh: '方阵人数算错——队列乱了！', en: 'Formation count wrong — ranks in disarray!' } }
  },
  {
    id: 786, grade: 7, unitId: 12, order: 2,
    unitTitle: { zh: 'Unit 12: 数的类型进阶', en: 'Unit 12: Advanced Number Types' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '奇偶药方', en: 'Odd-Even Elixir' },
    skillName: { zh: '奇偶数性质', en: 'Even & Odd Properties' },
    skillSummary: { zh: '奇+奇=偶，偶+偶=偶，奇+偶=奇', en: 'Odd+Odd=Even, Even+Even=Even, Odd+Even=Odd' },
    story: { zh: '军医配药：两种奇数剂量的药物混合，结果是奇数还是偶数？（1=偶, 2=奇）', en: 'Military doctor mixing medicines: two odd-dose medicines combined — is the result odd or even? (1=Even, 2=Odd)' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '诸葛亮：用例子验证\n$3 + 5 = 8$（偶数）✓\n$7 + 9 = 16$（偶数）✓\n$11 + 13 = 24$（偶数）✓\n\n奇数+奇数永远是偶数！', en: 'Zhuge Liang: "Verify with examples\n$3 + 5 = 8$ (even) ✓\n$7 + 9 = 16$ (even) ✓\n$11 + 13 = 24$ (even) ✓\n\nOdd + Odd is always even!"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：为什么？\n奇数 = 偶数 + 1。所以：\n$(2a+1) + (2b+1) = 2a + 2b + 2 = 2(a+b+1)$\n结果能被 2 整除→偶数！', en: 'Zhuge Liang: "Why?\nOdd = Even + 1. So:\n$(2a+1) + (2b+1) = 2a + 2b + 2 = 2(a+b+1)$\nResult is divisible by 2 → even!"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n两个奇数相加 = **偶数**。答案是 $1$。', en: 'Zhuge Liang: "Answer\nTwo odd numbers added = **even**. Answer is $1$."' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n再试一组：$99 + 101 = 200$（偶数）✓\n无论多大的奇数相加，结果永远是偶数——这是数学规律，不是巧合！', en: 'Zhuge Liang: "Verify\nOne more: $99 + 101 = 200$ (even) ✓\nNo matter how large the odd numbers, their sum is always even — a mathematical law, not coincidence!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '奇偶性（parity）是数的基本属性。同奇偶相加为偶，不同奇偶相加为奇。', en: 'Parity is a fundamental property of numbers. Same parity sums to even, different parity sums to odd.' }, formula: { zh: '$(2a+1)+(2b+1) = 2(a+b+1)$ → 偶数', en: '$(2a+1)+(2b+1) = 2(a+b+1)$ → even' }, tips: [{ zh: '诸葛亮提示：奇偶性——配药分组的隐形法则！', en: 'Zhuge Liang Tip: Parity — the hidden rule behind mixing and grouping!' }] },
    storyConsequence: { correct: { zh: '奇偶药方——偶数剂量配置正确！', en: 'Odd-Even Elixir — even dosage correctly determined!' }, wrong: { zh: '奇偶搞混了——药方配错了！', en: 'Parity confused — prescription mixed up!' } }
  },
  {
    id: 787, grade: 7, unitId: 12, order: 3,
    unitTitle: { zh: 'Unit 12: 数的类型进阶', en: 'Unit 12: Advanced Number Types' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '缩放还原术', en: 'Shrink-Restore Technique' },
    skillName: { zh: '倒数', en: 'Reciprocals' },
    skillSummary: { zh: '一个数的倒数 = 1÷那个数，两者相乘=1', en: 'Reciprocal of a number = 1 ÷ that number; their product = 1' },
    story: { zh: '诸葛亮的缩小射线把物体缩为 $\\frac{1}{5}$。要恢复原状，必须乘以多少？', en: 'Zhuge Liang\'s shrink ray reduces objects to $\\frac{1}{5}$. To restore, multiply by what?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '诸葛亮：求 $\\frac{1}{5}$ 的倒数\n把分子分母翻转：$\\frac{1}{5}$ → $\\frac{5}{1} = 5$', en: 'Zhuge Liang: "Find the reciprocal of $\\frac{1}{5}$\nFlip numerator and denominator: $\\frac{1}{5}$ → $\\frac{5}{1} = 5$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验证性质\n$\\frac{1}{5} \\times 5 = 1$ ✓\n互为倒数的两个数相乘一定等于 $1$！', en: 'Zhuge Liang: "Verify the property\n$\\frac{1}{5} \\times 5 = 1$ ✓\nTwo reciprocals multiplied always equal $1$!"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n$\\frac{1}{5}$ 的倒数是 $5$。', en: 'Zhuge Liang: "Answer\nThe reciprocal of $\\frac{1}{5}$ is $5$."' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$\\frac{1}{5} \\times 5 = \\frac{5}{5} = 1$ ✓\n除以一个数 = 乘以它的倒数，这就是为什么倒数如此重要！', en: 'Zhuge Liang: "Verify\n$\\frac{1}{5} \\times 5 = \\frac{5}{5} = 1$ ✓\nDividing by a number = multiplying by its reciprocal — that\'s why reciprocals matter!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '倒数就是"翻转"分数。一个数乘以它的倒数=1。除法本质上就是乘以倒数。', en: 'Reciprocal means "flipping" a fraction. A number times its reciprocal = 1. Division is essentially multiplying by the reciprocal.' }, formula: { zh: '$a \\times \\frac{1}{a} = 1$', en: '$a \\times \\frac{1}{a} = 1$' }, tips: [{ zh: '诸葛亮提示：翻转分数就是求倒数——缩小的反操作是放大！', en: 'Zhuge Liang Tip: Flip the fraction to find the reciprocal — the reverse of shrinking is enlarging!' }] },
    storyConsequence: { correct: { zh: '缩放还原——倒数精准，物体恢复原状！', en: 'Shrink-Restore — reciprocal correct, object restored!' }, wrong: { zh: '倒数算错——物体变形了！', en: 'Reciprocal wrong — object distorted!' } }
  },
  {
    id: 788, grade: 7, unitId: 12, order: 4,
    unitTitle: { zh: 'Unit 12: 数的类型进阶', en: 'Unit 12: Advanced Number Types' },
    topic: 'Algebra', type: 'FACTORS_LIST',
    title: { zh: '分糖编队', en: 'Candy Division Drill' },
    skillName: { zh: '因数与倍数', en: 'Factors & Multiples' },
    skillSummary: { zh: '因数能整除原数；倍数是原数的整数倍', en: 'Factors divide evenly; multiples are integer products' },
    story: { zh: '关羽分糖给士兵：$18$ 颗糖能平均分给几种人数？找出 $18$ 的所有因数！', en: 'Guan Yu distributes candy: 18 sweets shared equally — how many group sizes work? Find all factors of 18!' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '关羽：配对法找因数\n$1 \\times 18 = 18$ ✓\n$2 \\times 9 = 18$ ✓\n$3 \\times 6 = 18$ ✓\n$4 \\times ? = 18$：$18 \\div 4 = 4.5$ ✗\n$5 \\times ? = 18$：$18 \\div 5 = 3.6$ ✗', en: 'Guan Yu: "Pair method for factors\n$1 \\times 18 = 18$ ✓\n$2 \\times 9 = 18$ ✓\n$3 \\times 6 = 18$ ✓\n$4 \\times ? = 18$: $18 \\div 4 = 4.5$ ✗\n$5 \\times ? = 18$: $18 \\div 5 = 3.6$ ✗"' }, highlightField: 'ans' },
      { text: { zh: '关羽：收集因数\n$\\{1, 2, 3, 6, 9, 18\\}$\n共 $6$ 个因数。', en: 'Guan Yu: "Collect all factors\n$\\{1, 2, 3, 6, 9, 18\\}$\n$6$ factors total."' }, highlightField: 'ans' },
      { text: { zh: '关羽：答案\n$18$ 有 $6$ 个因数。\n可以分成 $1, 2, 3, 6, 9, 18$ 人的小组！', en: 'Guan Yu: "Answer\n$18$ has $6$ factors.\nGroups of $1, 2, 3, 6, 9$, or $18$ all work!"' }, highlightField: 'ans' },
      { text: { zh: '关羽：验算\n$18 \\div 1 = 18$ ✓, $18 \\div 2 = 9$ ✓, $18 \\div 3 = 6$ ✓\n$18 \\div 6 = 3$ ✓, $18 \\div 9 = 2$ ✓, $18 \\div 18 = 1$ ✓', en: 'Guan Yu: "Verify\n$18 \\div 1 = 18$ ✓, $18 \\div 2 = 9$ ✓, $18 \\div 3 = 6$ ✓\n$18 \\div 6 = 3$ ✓, $18 \\div 9 = 2$ ✓, $18 \\div 18 = 1$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '因数是能整除一个数的数，倍数是一个数的整数倍。因数有限，倍数无限。', en: 'Factors divide a number evenly. Multiples are integer products of a number. Factors are finite, multiples are infinite.' }, formula: { zh: '$n \\div f = $ 整数 → $f$ 是 $n$ 的因数', en: '$n \\div f =$ integer → $f$ is a factor of $n$' }, tips: [{ zh: '关羽提示：配对法——从1开始，两头往中间找，效率翻倍！', en: 'Guan Yu Tip: Pair method — start from 1, work inward from both ends, double efficiency!' }] },
    storyConsequence: { correct: { zh: '分糖编队——6种分法全部找到！', en: 'Candy Division — all 6 factor groups found!' }, wrong: { zh: '因数漏了——有些士兵分不到糖！', en: 'Factors missed — some soldiers got no candy!' } }
  },
  {
    id: 789, grade: 7, unitId: 12, order: 5,
    unitTitle: { zh: 'Unit 12: 数的类型进阶', en: 'Unit 12: Advanced Number Types' },
    topic: 'Algebra', type: 'HCF',
    title: { zh: '公交同站', en: 'Bus Stop Rendezvous' },
    skillName: { zh: 'HCF与LCM', en: 'HCF & LCM' },
    skillSummary: { zh: 'HCF=最大公因数，LCM=最小公倍数', en: 'HCF = Highest Common Factor, LCM = Lowest Common Multiple' },
    story: { zh: '两辆运粮车一辆 $12$ 分钟一班、一辆 $18$ 分钟一班。它们的最大公因数是？', en: 'Two supply wagons: one every 12 min, one every 18 min. What is their HCF?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '张飞：找共有因数\n共有 $2$（最小次幂 $2^1$）和 $3$（最小次幂 $3^1$）\nHCF $= 2 \\times 3 = 6$', en: 'Zhang Fei: "Find common factors\nShared: $2$ (lowest power $2^1$) and $3$ (lowest power $3^1$)\nHCF $= 2 \\times 3 = 6$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：列举法验证\n$12$ 的因数：$\\{1, 2, 3, 4, 6, 12\\}$\n$18$ 的因数：$\\{1, 2, 3, 6, 9, 18\\}$\n公因数：$\\{1, 2, 3, 6\\}$\n最大的 $= 6$ ✓', en: 'Zhang Fei: "List method verification\nFactors of 12: $\\{1, 2, 3, 4, 6, 12\\}$\nFactors of 18: $\\{1, 2, 3, 6, 9, 18\\}$\nCommon: $\\{1, 2, 3, 6\\}$\nLargest $= 6$ ✓"' }, highlightField: 'ans' },
      { text: { zh: '张飞：答案\nHCF$(12, 18) = 6$', en: 'Zhang Fei: "Answer\nHCF$(12, 18) = 6$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：验算\n$12 \\div 6 = 2$ ✓, $18 \\div 6 = 3$ ✓\n$6$ 能同时整除 $12$ 和 $18$，且没有更大的数能做到。\n\n延伸：LCM $= \\frac{12 \\times 18}{6} = 36$（同时到站需 $36$ 分钟）', en: 'Zhang Fei: "Verify\n$12 \\div 6 = 2$ ✓, $18 \\div 6 = 3$ ✓\n$6$ divides both 12 and 18, and no larger number does.\n\nBonus: LCM $= \\frac{12 \\times 18}{6} = 36$ (buses meet after 36 min)"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: 'HCF是两个数共有因数中最大的。用质因数分解法：取共有质因数的最小次幂相乘。', en: 'HCF is the largest shared factor. Use prime factorisation: multiply shared primes with lowest powers.' }, formula: { zh: '$\\text{HCF} = $ 共有质因数的最小次幂之积', en: '$\\text{HCF} =$ product of shared primes with lowest powers' }, tips: [{ zh: '张飞提示：HCF取最小，LCM取最大——别搞反了！', en: 'Zhang Fei Tip: HCF takes the smallest power, LCM takes the largest — don\'t mix them up!' }] },
    storyConsequence: { correct: { zh: '公交同站——HCF=6精准计算！', en: 'Bus Stop Rendezvous — HCF=6 perfectly calculated!' }, wrong: { zh: '公因数算错——两车错过了！', en: 'Common factor wrong — buses missed each other!' } }
  },
  // --- Year 7 Unit 13: 集合与韦恩图 (Topic 1.2) ---
  {
    id: 790, grade: 7, unitId: 13, order: 1,
    unitTitle: { zh: 'Unit 13: 集合与韦恩图', en: 'Unit 13: Sets & Venn Diagrams' },
    topic: 'Algebra', type: 'VENN',
    title: { zh: '校场分队', en: 'Training Ground Sorting' },
    discoverSteps: [{
      prompt: { zh: '班上有些人踢足球，有些人打网球，还有些两个都玩。\n如果踢足球15人，打网球12人，两个都玩的有5人——那只踢足球的有几人？', en: 'Some students play football, some play tennis, some play both.\nIf 15 play football, 12 play tennis, and 5 play both — how many play ONLY football?' },
      type: 'choice' as const,
      choices: [
        { zh: '10人（$15 - 5 = 10$）', en: '10 ($15 - 5 = 10$)' },
        { zh: '15人（所有踢足球的）', en: '15 (all football players)' },
      ],
      onCorrect: { zh: '对！"只踢足球"= 踢足球的总人数 减去 两个都玩的。$15 - 5 = 10$。韦恩图就是把这种"重叠"看清楚的工具！', en: 'Right! "Only football" = total football minus both. $15 - 5 = 10$. Venn diagrams are the tool to see this overlap clearly!' },
      onWrong: { zh: '15人是所有踢足球的，包括两个都玩的5人。"只踢足球"要减掉重叠部分：$15-5=10$。', en: '15 includes those who play both. "Only football" must subtract the overlap: $15-5=10$.' },
      onSkip: { zh: '韦恩图帮你分清"只A"、"只B"和"A且B"。踢足球15人中有5人也打网球，所以只踢足球的=$15-5=10$。', en: 'Venn diagrams separate "only A", "only B", and "A and B". Of 15 footballers, 5 also play tennis, so only football = $15-5=10$.' },
    }],
    skillName: { zh: '韦恩图基础', en: 'Venn Diagram Basics' },
    skillSummary: { zh: '用韦恩图表示集合的交集和并集', en: 'Use Venn diagrams to show intersection and union of sets' },
    story: { zh: '赵云在校场分队：踢足球 $15$ 人，打网球 $12$ 人，两个都玩 $5$ 人。只踢足球的有几人？', en: 'Zhao Yun sorts the troops: 15 play football, 12 play tennis, 5 play both. How many play ONLY football?' },
    description: { zh: '只踢足球的有几人？（总数减去交集）', en: 'How many play only football? (Total minus intersection)' },
    data: { answer: 5, generatorType: 'VENN_RANDOM' }, difficulty: 'Easy', reward: 35,
    kpId: 'kp-1.2-01', sectionId: 'number',
    tutorialSteps: [
      { text: { zh: '赵云：为什么要学韦恩图？\n校场上有些人踢足球，有些打网球，有些两个都玩——怎么数清楚？韦恩图用两个圆的重叠来表示"既...又..."的人，一眼就能看出谁属于哪组！', en: 'Zhao Yun: "Why learn Venn diagrams?\nSome play football, some tennis, some both — how to count accurately? Venn diagrams use overlapping circles to show \'both...and...\' — instantly clear who belongs where!"' }, highlightField: 'ans' },
      { text: { zh: '赵云：韦恩图结构\n左圆=足球，右圆=网球\n重叠部分=两个都玩\n\n$|\\text{只A}| = |A| - |A \\cap B|$', en: 'Zhao Yun: "Venn diagram structure\nLeft circle = Football, Right circle = Tennis\nOverlap = play both\n\n$|\\text{Only A}| = |A| - |A \\cap B|$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：代入数据\n足球总人数 $= 15$\n两个都玩 $= 5$\n只踢足球 $= 15 - 5$', en: 'Zhao Yun: "Substitute\nTotal football $= 15$\nBoth $= 5$\nOnly football $= 15 - 5$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：计算\n$15 - 5 = 10$\n\n同理：只打网球 $= 12 - 5 = 7$', en: 'Zhao Yun: "Calculate\n$15 - 5 = 10$\n\nSimilarly: only tennis $= 12 - 5 = 7$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：答案\n只踢足球的有 $10$ 人。\n韦恩图：左区10 | 重叠5 | 右区7', en: 'Zhao Yun: "Answer\n$10$ play only football.\nVenn: Left 10 | Overlap 5 | Right 7"' }, highlightField: 'ans' },
      { text: { zh: '赵云：验算\n只足球 + 两都 + 只网球 $= 10 + 5 + 7 = 22$\n$|A \\cup B| = |A| + |B| - |A \\cap B| = 15 + 12 - 5 = 22$ ✓', en: 'Zhao Yun: "Verify\nOnly football + Both + Only tennis $= 10 + 5 + 7 = 22$\n$|A \\cup B| = |A| + |B| - |A \\cap B| = 15 + 12 - 5 = 22$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '韦恩图用圆的重叠表示集合关系。只属于A = A的总数 - 交集。', en: 'Venn diagrams use overlapping circles for set relationships. Only in A = total A minus intersection.' }, formula: { zh: '$|A \\text{ only}| = |A| - |A \\cap B|$', en: '$|A \\text{ only}| = |A| - |A \\cap B|$' }, tips: [{ zh: '赵云提示：先填交集，再算两边——从中间开始！', en: 'Zhao Yun Tip: Fill the intersection first, then calculate the sides — start from the middle!' }] },
    storyConsequence: { correct: { zh: '校场分队——韦恩图清晰明了！', en: 'Training Ground Sorting — Venn diagram crystal clear!' }, wrong: { zh: '分队数错了——有人被重复计算！', en: 'Sorting error — someone was double-counted!' } }
  },
  {
    id: 791, grade: 7, unitId: 13, order: 2,
    unitTitle: { zh: 'Unit 13: 集合与韦恩图', en: 'Unit 13: Sets & Venn Diagrams' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '三军合围', en: 'Three-Army Encirclement' },
    skillName: { zh: '三集合韦恩图', en: 'Three-Set Venn Diagrams' },
    skillSummary: { zh: '三个集合的韦恩图需要从中心交集开始填写', en: 'Three-set Venn diagrams: start from the centre intersection' },
    story: { zh: '刘备三军合围：A军 $10$ 人、B军 $8$ 人、C军 $6$ 人。$A \\cap B = 3$, $B \\cap C = 2$, $A \\cap C = 1$, $A \\cap B \\cap C = 1$。只在A军的有几人？', en: 'Liu Bei\'s three-army siege: A has 10, B has 8, C has 6. $A \\cap B = 3$, $B \\cap C = 2$, $A \\cap C = 1$, $A \\cap B \\cap C = 1$. How many are ONLY in A?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '刘备：求"只在A"的人数\n只A $= |A| - $ 只A∩B $-$ 只A∩C $- A \\cap B \\cap C$\n$= 10 - 2 - 0 - 1 = 7$', en: 'Liu Bei: "Find \'only in A\'\nOnly A $= |A| -$ only A∩B $-$ only A∩C $- A \\cap B \\cap C$\n$= 10 - 2 - 0 - 1 = 7$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：图示\nA区：只A=$7$ | A∩B=$2$ | A∩C=$0$ | 中心=$1$\n总计 $7+2+0+1 = 10$ ✓', en: 'Liu Bei: "Diagram\nA region: Only A=$7$ | A∩B=$2$ | A∩C=$0$ | Centre=$1$\nTotal $7+2+0+1 = 10$ ✓"' }, highlightField: 'ans' },
      { text: { zh: '刘备：答案\n只在A军的有 $7$ 人。', en: 'Liu Bei: "Answer\nOnly in army A: $7$ soldiers."' }, highlightField: 'ans' },
      { text: { zh: '刘备：验算\nA中所有人：只A($7$) + 只A∩B($2$) + 只A∩C($0$) + A∩B∩C($1$) $= 10$ ✓\n同理验B：只B = $8-2-1-1 = 4$, $4+2+1+1=8$ ✓', en: 'Liu Bei: "Verify\nAll in A: Only A($7$) + A∩B only($2$) + A∩C only($0$) + A∩B∩C($1$) $= 10$ ✓\nCheck B: Only B = $8-2-1-1 = 4$, $4+2+1+1=8$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '三集合韦恩图：从中心 A∩B∩C 开始，逐层向外剥离，最后算"只属于一个"的区域。', en: 'Three-set Venn: start from centre A∩B∩C, peel outward layer by layer, then calculate "only one set" regions.' }, formula: { zh: '只A $= |A| - |A \\cap B \\text{ only}| - |A \\cap C \\text{ only}| - |A \\cap B \\cap C|$', en: 'Only A $= |A| - |A \\cap B \\text{ only}| - |A \\cap C \\text{ only}| - |A \\cap B \\cap C|$' }, tips: [{ zh: '刘备提示：三集合永远从中心开始填——先填1个，再填2个，最后填3个区域！', en: 'Liu Bei Tip: Three-set always start from the centre — fill 1 region, then 2, then 3!' }] },
    storyConsequence: { correct: { zh: '三军合围——7人精准定位！', en: 'Three-Army Encirclement — 7 soldiers precisely located!' }, wrong: { zh: '韦恩图填错——兵力部署混乱！', en: 'Venn diagram error — troop deployment confused!' } }
  },
  {
    id: 792, grade: 7, unitId: 13, order: 3,
    unitTitle: { zh: 'Unit 13: 集合与韦恩图', en: 'Unit 13: Sets & Venn Diagrams' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '并集清点', en: 'Union Head Count' },
    skillName: { zh: '并集交集与补集', en: 'Union, Intersection & Complement' },
    skillSummary: { zh: 'A∪B = A + B - A∩B；补集 = 全集 - 集合', en: 'A∪B = A + B - A∩B; Complement = Universal - Set' },
    story: { zh: '全集 $U = \\{1, 2, ..., 20\\}$，$A$ = 偶数集，$B$ = 3的倍数集。$A \\cup B$ 有几个元素？', en: 'Universal set $U = \\{1, 2, ..., 20\\}$, $A$ = even numbers, $B$ = multiples of 3. How many elements in $A \\cup B$?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '关羽：容斥公式\n$$|A \\cup B| = |A| + |B| - |A \\cap B|$$\n$= 10 + 6 - 3$', en: 'Guan Yu: "Inclusion-exclusion formula\n$$|A \\cup B| = |A| + |B| - |A \\cap B|$$\n$= 10 + 6 - 3$"' }, highlightField: 'ans' },
      { text: { zh: '关羽：计算\n$10 + 6 - 3 = 13$', en: 'Guan Yu: "Calculate\n$10 + 6 - 3 = 13$"' }, highlightField: 'ans' },
      { text: { zh: '关羽：答案\n$|A \\cup B| = 13$\n\n补集：$|A\' \\cap B\'| = 20 - 13 = 7$（既不是偶数也不是3的倍数的有7个）', en: 'Guan Yu: "Answer\n$|A \\cup B| = 13$\n\nComplement: $|A\' \\cap B\'| = 20 - 13 = 7$ (neither even nor multiple of 3: 7 numbers)"' }, highlightField: 'ans' },
      { text: { zh: '关羽：验算\n列出 $A \\cup B$：$\\{2,3,4,6,8,9,10,12,14,15,16,18,20\\}$\n数一数：$13$ 个 ✓', en: 'Guan Yu: "Verify\nList $A \\cup B$: $\\{2,3,4,6,8,9,10,12,14,15,16,18,20\\}$\nCount: $13$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '并集用容斥原理：A∪B = A + B - A∩B，避免重复计算。补集 = 全集 - 集合。', en: 'Union uses inclusion-exclusion: A∪B = A + B - A∩B, avoiding double-counting. Complement = Universal - Set.' }, formula: { zh: '$|A \\cup B| = |A| + |B| - |A \\cap B|$', en: '$|A \\cup B| = |A| + |B| - |A \\cap B|$' }, tips: [{ zh: '关羽提示：加了两次的要减回一次——容斥原理的核心！', en: 'Guan Yu Tip: What\'s counted twice must be subtracted once — the heart of inclusion-exclusion!' }] },
    storyConsequence: { correct: { zh: '并集清点——13个元素一个不差！', en: 'Union Head Count — all 13 elements accounted for!' }, wrong: { zh: '并集算错——有人被重复统计了！', en: 'Union wrong — someone was double-counted!' } }
  },
  {
    id: 793, grade: 7, unitId: 13, order: 4,
    unitTitle: { zh: 'Unit 13: 集合与韦恩图', en: 'Unit 13: Sets & Venn Diagrams' },
    topic: 'Algebra', type: 'VENN',
    title: { zh: '韦恩图实战', en: 'Venn Diagram Word Problem' },
    skillName: { zh: '韦恩图应用题', en: 'Venn Problem Solving' },
    skillSummary: { zh: '用韦恩图解决实际问题：先填交集再算各区域', en: 'Solve real problems with Venn diagrams: fill intersection first, then regions' },
    story: { zh: '$30$ 名士兵中喜欢篮球 $20$ 人、足球 $15$ 人。两个都喜欢的至少有几人？', en: '30 soldiers: 20 like basketball, 15 like football. At least how many like both?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '赵云：代入计算\n$|A \\cap B| \\geq 20 + 15 - 30 = 5$\n两个都喜欢的至少 $5$ 人。', en: 'Zhao Yun: "Substitute\n$|A \\cap B| \\geq 20 + 15 - 30 = 5$\nAt least $5$ like both."' }, highlightField: 'ans' },
      { text: { zh: '赵云：填韦恩图\n只篮球 $= 20 - 5 = 15$\n两都 $= 5$\n只足球 $= 15 - 5 = 10$\n总计 $= 15 + 5 + 10 = 30$ ✓', en: 'Zhao Yun: "Fill the Venn diagram\nOnly basketball $= 20 - 5 = 15$\nBoth $= 5$\nOnly football $= 15 - 5 = 10$\nTotal $= 15 + 5 + 10 = 30$ ✓"' }, highlightField: 'ans' },
      { text: { zh: '赵云：答案\n两个都喜欢的至少有 $5$ 人。', en: 'Zhao Yun: "Answer\nAt least $5$ like both."' }, highlightField: 'ans' },
      { text: { zh: '赵云：验算\n$15 + 5 + 10 = 30$ ✓（等于总人数）\n篮球总数：$15 + 5 = 20$ ✓\n足球总数：$5 + 10 = 15$ ✓', en: 'Zhao Yun: "Verify\n$15 + 5 + 10 = 30$ ✓ (equals total)\nBasketball total: $15 + 5 = 20$ ✓\nFootball total: $5 + 10 = 15$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '当两组总和超过全集大小时，超出的部分就是至少的交集人数：A∩B ≥ A + B - 全集。', en: 'When two groups\' total exceeds the universal set, the excess is the minimum intersection: A∩B ≥ A + B - Universal.' }, formula: { zh: '$|A \\cap B| \\geq |A| + |B| - |U|$', en: '$|A \\cap B| \\geq |A| + |B| - |U|$' }, tips: [{ zh: '赵云提示：总和超过全集？多出来的就是"重叠"的最少人数！', en: 'Zhao Yun Tip: Sum exceeds universal set? The excess is the minimum overlap!' }] },
    storyConsequence: { correct: { zh: '韦恩图实战——5人精准定位！', en: 'Venn Diagram Problem — 5 people precisely identified!' }, wrong: { zh: '重叠人数算错——统计出了差错！', en: 'Overlap count wrong — census error!' } }
  },
  // --- Year 7 Unit 14: 进阶运算 (Topics 1.4/1.6/1.7/1.8) ---
  {
    id: 794, grade: 7, unitId: 14, order: 1,
    unitTitle: { zh: 'Unit 14: 进阶运算', en: 'Unit 14: Advanced Operations' },
    topic: 'Algebra', type: 'FDP_CONVERT',
    title: { zh: '折扣谍报', en: 'Discount Intelligence' },
    discoverSteps: [{
      prompt: { zh: '$\\frac{1}{3}$ 折扣 vs $30\\%$ 折扣，哪个更划算？\n先把 $\\frac{1}{3}$ 转成百分比试试。', en: '$\\frac{1}{3}$ discount vs $30\\%$ discount — which saves more?\nTry converting $\\frac{1}{3}$ to a percentage first.' },
      type: 'choice' as const,
      choices: [
        { zh: '$\\frac{1}{3} \\approx 33.3\\%$，比 $30\\%$ 大', en: '$\\frac{1}{3} \\approx 33.3\\%$, bigger than $30\\%$' },
        { zh: '$\\frac{1}{3} = 30\\%$，一样大', en: '$\\frac{1}{3} = 30\\%$, they\'re equal' },
      ],
      onCorrect: { zh: '对！$\\frac{1}{3} = 0.\\overline{3} \\approx 33.3\\% > 30\\%$。分数和百分比互转是比较大小的关键技能！', en: 'Right! $\\frac{1}{3} = 0.\\overline{3} \\approx 33.3\\% > 30\\%$. Converting between fractions and percentages is key to comparison!' },
      onWrong: { zh: '$\\frac{1}{3} = 1 \\div 3 = 0.333... = 33.3\\%$，不是 $30\\%$！差了 $3.3\\%$。', en: '$\\frac{1}{3} = 1 \\div 3 = 0.333... = 33.3\\%$, not $30\\%$! A $3.3\\%$ difference.' },
      onSkip: { zh: '分数→小数：$1 \\div 3 = 0.333...$\n小数→百分比：$0.333... \\times 100 = 33.3\\%$\n所以 $\\frac{1}{3}$ 折扣更划算！', en: 'Fraction→decimal: $1 \\div 3 = 0.333...$\nDecimal→percentage: $0.333... \\times 100 = 33.3\\%$\nSo $\\frac{1}{3}$ discount saves more!' },
    }],
    skillName: { zh: '分小百互转', en: 'FDP Conversion' },
    skillSummary: { zh: '分数↔小数↔百分数之间的转换', en: 'Convert between fractions, decimals, and percentages' },
    story: { zh: '诸葛亮要比较谍报价格：$\\frac{1}{3}$ 的折扣等于多少小数？', en: 'Zhuge Liang compares intelligence prices: what is $\\frac{1}{3}$ as a decimal?' },
    description: { zh: '$\\frac{1}{3}$ 转小数（保留3位）= ?', en: '$\\frac{1}{3}$ as a decimal (3dp) = ?' },
    data: { answer: 0.333, generatorType: 'FDP_CONVERT_RANDOM' }, difficulty: 'Easy', reward: 35,
    kpId: 'kp-1.4-04', sectionId: 'number',
    tutorialSteps: [
      { text: { zh: '诸葛亮：为什么要会分小百互转？\n$\\frac{1}{3}$ 折扣和 $30\\%$ 折扣哪个更划算？不转换就没法比！分数、小数、百分数是同一个量的三种表达方式——掌握互转，才能灵活比较和计算。', en: 'Zhuge Liang: "Why learn FDP conversion?\n$\\frac{1}{3}$ discount vs $30\\%$ — which is better? Can\'t compare without converting! Fractions, decimals, percentages are three ways to express the same quantity — master conversion for flexible comparison and calculation."' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：转换规则\n分数→小数：分子÷分母\n小数→百分数：×100\n百分数→分数：÷100再化简', en: 'Zhuge Liang: "Conversion rules\nFraction→Decimal: numerator ÷ denominator\nDecimal→Percentage: ×100\nPercentage→Fraction: ÷100 then simplify"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：计算\n$\\frac{1}{3} = 1 \\div 3 = 0.333...$', en: 'Zhuge Liang: "Calculate\n$\\frac{1}{3} = 1 \\div 3 = 0.333...$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：循环小数\n$0.333...$ 是循环小数，写作 $0.\\overline{3}$\n保留3位小数 $= 0.333$', en: 'Zhuge Liang: "Recurring decimal\n$0.333...$ is a recurring decimal, written $0.\\overline{3}$\nRounded to 3dp $= 0.333$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n$\\frac{1}{3} = 0.333$（保留3位小数）', en: 'Zhuge Liang: "Answer\n$\\frac{1}{3} = 0.333$ (to 3dp)"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$0.333 \\times 3 = 0.999 \\approx 1$ ✓\n（精确值 $0.\\overline{3} \\times 3 = 1$）', en: 'Zhuge Liang: "Verify\n$0.333 \\times 3 = 0.999 \\approx 1$ ✓\n(Exact: $0.\\overline{3} \\times 3 = 1$)"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '分数÷得小数，×100得百分数。它们是同一个量的三种语言。', en: 'Fraction ÷ gives decimal, ×100 gives percentage. Three languages for the same quantity.' }, formula: { zh: '$\\frac{a}{b} = a \\div b$；小数 $\\times 100 = $ 百分数', en: '$\\frac{a}{b} = a \\div b$; decimal $\\times 100 =$ percentage' }, tips: [{ zh: '诸葛亮提示：记住常用转换——$\\frac{1}{3}=0.\\overline{3}=33.\\overline{3}\\%$！', en: 'Zhuge Liang Tip: Memorise common conversions — $\\frac{1}{3}=0.\\overline{3}=33.\\overline{3}\\%$!' }] },
    storyConsequence: { correct: { zh: '折扣谍报——0.333精准转换！', en: 'Discount Intelligence — 0.333 converted perfectly!' }, wrong: { zh: '分小转换出错——折扣算错了！', en: 'FDP conversion wrong — discount miscalculated!' } }
  },
  {
    id: 795, grade: 7, unitId: 14, order: 2,
    unitTitle: { zh: 'Unit 14: 进阶运算', en: 'Unit 14: Advanced Operations' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '小数陷阱', en: 'Decimal Trap' },
    skillName: { zh: '小数乘法', en: 'Decimal Multiplication' },
    skillSummary: { zh: '小数相乘：先忽略小数点算整数，再数总小数位数', en: 'Decimal multiplication: multiply as integers, then count total decimal places' },
    story: { zh: '军需官计算：$0.6 \\times 0.3 = ?$\n大多数学生说 $0.18$——但对吗？', en: 'Supply officer calculates: $0.6 \\times 0.3 = ?$\nMost students say $0.18$ — but is that right?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '张飞：放回小数点\n$18$ 加 $2$ 位小数 → $0.18$', en: 'Zhang Fei: "Put the decimal point back\n$18$ with $2$ decimal places → $0.18$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：分数验证\n$0.6 = \\frac{6}{10}$，$0.3 = \\frac{3}{10}$\n$\\frac{6}{10} \\times \\frac{3}{10} = \\frac{18}{100} = 0.18$ ✓', en: 'Zhang Fei: "Fraction verification\n$0.6 = \\frac{6}{10}$, $0.3 = \\frac{3}{10}$\n$\\frac{6}{10} \\times \\frac{3}{10} = \\frac{18}{100} = 0.18$ ✓"' }, highlightField: 'ans' },
      { text: { zh: '张飞：答案\n$0.6 \\times 0.3 = 0.18$', en: 'Zhang Fei: "Answer\n$0.6 \\times 0.3 = 0.18$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：验算\n$0.18 \\div 0.6 = 0.3$ ✓\n$0.18 \\div 0.3 = 0.6$ ✓\n两个小于1的数相乘，结果一定更小！', en: 'Zhang Fei: "Verify\n$0.18 \\div 0.6 = 0.3$ ✓\n$0.18 \\div 0.3 = 0.6$ ✓\nTwo numbers less than 1 multiplied always give a smaller result!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '小数乘法：先算整数乘法，再数两个因数的总小数位数放回去。两个小于1的数相乘结果更小。', en: 'Decimal multiplication: multiply as integers, count total decimal places. Two numbers less than 1 multiply to give a smaller result.' }, formula: { zh: '小数位数之和 = 结果的小数位数', en: 'Sum of decimal places = decimal places in result' }, tips: [{ zh: '张飞提示：小数相乘不是变大——两个小于1的数乘出来更小！', en: 'Zhang Fei Tip: Decimal multiplication doesn\'t make things bigger — two numbers < 1 multiply to something smaller!' }] },
    storyConsequence: { correct: { zh: '小数陷阱——0.18精准破解！', en: 'Decimal Trap — 0.18 precisely solved!' }, wrong: { zh: '小数点放错了——军需账目出错！', en: 'Decimal point misplaced — supply accounts wrong!' } }
  },
  {
    id: 796, grade: 7, unitId: 14, order: 3,
    unitTitle: { zh: 'Unit 14: 进阶运算', en: 'Unit 14: Advanced Operations' },
    topic: 'Algebra', type: 'SQUARE_ROOT',
    title: { zh: '开方还原', en: 'Root Restoration' },
    skillName: { zh: '负指数与分数指数', en: 'Negative & Fractional Indices' },
    skillSummary: { zh: '$a^{1/2}=\\sqrt{a}$，分数指数就是开方', en: '$a^{1/2}=\\sqrt{a}$, fractional index means root' },
    story: { zh: '诸葛亮说：$4^{1/2}$ 是什么意思？就是开平方根！$\\sqrt{4} = ?$', en: 'Zhuge Liang says: what does $4^{1/2}$ mean? It\'s the square root! $\\sqrt{4} = ?$' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '诸葛亮：求 $4^{1/2}$\n$4^{1/2} = \\sqrt{4}$\n什么数 × 自己 = 4？', en: 'Zhuge Liang: "Find $4^{1/2}$\n$4^{1/2} = \\sqrt{4}$\nWhat number × itself = 4?"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：$2 \\times 2 = 4$\n所以 $\\sqrt{4} = 2$', en: 'Zhuge Liang: "$2 \\times 2 = 4$\nSo $\\sqrt{4} = 2$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n$4^{1/2} = 2$', en: 'Zhuge Liang: "Answer\n$4^{1/2} = 2$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$2^2 = 4$ ✓\n$(4^{1/2})^2 = 4^{(1/2 \\times 2)} = 4^1 = 4$ ✓\n指数法则完美自洽！', en: 'Zhuge Liang: "Verify\n$2^2 = 4$ ✓\n$(4^{1/2})^2 = 4^{(1/2 \\times 2)} = 4^1 = 4$ ✓\nIndex laws are perfectly consistent!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '分数指数就是开方：$a^{1/n} = \\sqrt[n]{a}$。负指数就是倒数：$a^{-n} = \\frac{1}{a^n}$。', en: 'Fractional index = root: $a^{1/n} = \\sqrt[n]{a}$. Negative index = reciprocal: $a^{-n} = \\frac{1}{a^n}$.' }, formula: { zh: '$a^{1/2} = \\sqrt{a}$', en: '$a^{1/2} = \\sqrt{a}$' }, tips: [{ zh: '诸葛亮提示：分数指数=开方，负指数=倒数——两个法则统一了所有指数运算！', en: 'Zhuge Liang Tip: Fractional index = root, negative index = reciprocal — two rules unify all index operations!' }] },
    storyConsequence: { correct: { zh: '开方还原——$\\sqrt{4}=2$ 完美！', en: 'Root Restoration — $\\sqrt{4}=2$ perfect!' }, wrong: { zh: '开方算错——指数法则还要练！', en: 'Root wrong — index laws need more practice!' } }
  },
  {
    id: 797, grade: 7, unitId: 14, order: 4,
    unitTitle: { zh: 'Unit 14: 进阶运算', en: 'Unit 14: Advanced Operations' },
    topic: 'Algebra', type: 'STD_FORM',
    title: { zh: '天文数字', en: 'Astronomical Numbers' },
    skillName: { zh: '标准式运算', en: 'Standard Form Calculations' },
    skillSummary: { zh: '$a \\times 10^n$ 形式的乘除运算', en: 'Multiply and divide numbers in $a \\times 10^n$ form' },
    story: { zh: '诸葛亮测算星辰距离：$(2 \\times 10^3) \\times (3 \\times 10^2) = a \\times 10^n$。求 $a$ 和 $n$。', en: 'Zhuge Liang calculates star distances: $(2 \\times 10^3) \\times (3 \\times 10^2) = a \\times 10^n$. Find $a$ and $n$.' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '诸葛亮：代入\n$a \\times b = 2 \\times 3 = 6$\n$m + n = 3 + 2 = 5$', en: 'Zhuge Liang: "Substitute\n$a \\times b = 2 \\times 3 = 6$\n$m + n = 3 + 2 = 5$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：检查标准式要求\n$1 \\leq a < 10$：$6$ ✓（已经是标准式）\n\n如果 $a \\geq 10$，需要调整：如 $12 \\times 10^5 = 1.2 \\times 10^6$', en: 'Zhuge Liang: "Check standard form requirement\n$1 \\leq a < 10$: $6$ ✓ (already in standard form)\n\nIf $a \\geq 10$, adjust: e.g. $12 \\times 10^5 = 1.2 \\times 10^6$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：答案\n$(2 \\times 10^3) \\times (3 \\times 10^2) = 6 \\times 10^5$\n$a = 6$, $n = 5$', en: 'Zhuge Liang: "Answer\n$(2 \\times 10^3) \\times (3 \\times 10^2) = 6 \\times 10^5$\n$a = 6$, $n = 5$"' }, highlightField: 'ans' },
      { text: { zh: '诸葛亮：验算\n$6 \\times 10^5 = 600000$\n$2000 \\times 300 = 600000$ ✓', en: 'Zhuge Liang: "Verify\n$6 \\times 10^5 = 600000$\n$2000 \\times 300 = 600000$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '标准式乘法：系数相乘，指数相加。如果系数≥10，再调整回标准式。', en: 'Standard form multiplication: multiply coefficients, add indices. If coefficient ≥ 10, adjust back to standard form.' }, formula: { zh: '$(a \\times 10^m)(b \\times 10^n) = ab \\times 10^{m+n}$', en: '$(a \\times 10^m)(b \\times 10^n) = ab \\times 10^{m+n}$' }, tips: [{ zh: '诸葛亮提示：系数乘指数加——标准式运算的口诀！', en: 'Zhuge Liang Tip: Multiply coefficients, add indices — the standard form mantra!' }] },
    storyConsequence: { correct: { zh: '天文数字——$6 \\times 10^5$ 精准计算！', en: 'Astronomical Numbers — $6 \\times 10^5$ calculated perfectly!' }, wrong: { zh: '标准式算错——星辰距离偏差了！', en: 'Standard form wrong — star distance miscalculated!' } }
  },
  // --- Year 7 Unit 15: 估算进阶 (Topic 1.9) ---
  {
    id: 798, grade: 7, unitId: 15, order: 1,
    unitTitle: { zh: 'Unit 15: 估算进阶', en: 'Unit 15: Advanced Estimation' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '截断术', en: 'Truncation Technique' },
    discoverSteps: [{
      prompt: { zh: '$\\pi = 3.14159...$\n\n只要2位小数——截断和四舍五入有什么区别？\n截断：直接砍掉后面的数字\n四舍五入：看第3位决定进还是舍', en: '$\\pi = 3.14159...$\n\nKeep 2 decimal places — what\'s the difference between truncation and rounding?\nTruncation: chop off the rest\nRounding: look at the 3rd decimal to decide' },
      type: 'choice' as const,
      choices: [
        { zh: '截断=3.14，四舍五入=3.14（这次碰巧一样）', en: 'Truncation=3.14, Rounding=3.14 (same this time)' },
        { zh: '截断=3.14，四舍五入=3.15', en: 'Truncation=3.14, Rounding=3.15' },
      ],
      onCorrect: { zh: '对！第3位是1（<5），四舍五入也是3.14。但如果是3.145，截断=3.14而四舍五入=3.15——区别就出来了！', en: 'Right! The 3rd decimal is 1 (<5), so rounding also gives 3.14. But for 3.145, truncation=3.14 while rounding=3.15 — that\'s the difference!' },
      onWrong: { zh: '第3位小数是1（3.14**1**59），1<5所以四舍五入也舍入为3.14。碰巧这次结果一样！', en: 'The 3rd decimal is 1 (3.14**1**59), 1<5 so rounding also gives 3.14. Coincidentally the same this time!' },
      onSkip: { zh: '截断：直接砍掉→3.14。四舍五入：第3位=1<5→也是3.14。\n区别在3.146时：截断=3.14，四舍五入=3.15。', en: 'Truncation: chop→3.14. Rounding: 3rd dp=1<5→also 3.14.\nDifference shows with 3.146: truncation=3.14, rounding=3.15.' },
    }],
    skillName: { zh: '截断与四舍五入', en: 'Truncation vs Rounding' },
    skillSummary: { zh: '截断=直接去掉多余位数；四舍五入=看下一位决定', en: 'Truncation = chop off extra digits; Rounding = look at next digit to decide' },
    story: { zh: '军医记录药量：$3.14159$ 截断到2位小数（不四舍五入）= ?', en: 'Military doctor records dosage: truncate $3.14159$ to 2dp (no rounding) = ?' },
    description: { zh: '$3.14159$ 截断到2位小数 = ?', en: 'Truncate $3.14159$ to 2dp = ?' },
    data: { answer: 3.14 }, difficulty: 'Easy', reward: 30,
    kpId: 'kp-1.9-03', sectionId: 'number',
    tutorialSteps: [
      { text: { zh: '赵云：截断和四舍五入有什么区别？\n截断=直接砍掉后面的数字，不管下一位是多少。四舍五入=看下一位，≥5就进位。工程和计算机中经常用截断，因为它简单且可预测。', en: 'Zhao Yun: "What\'s the difference between truncation and rounding?\nTruncation = chop off the rest, regardless of what comes next. Rounding = look at the next digit, ≥5 means round up. Engineering and computing often use truncation because it\'s simple and predictable."' }, highlightField: 'ans' },
      { text: { zh: '赵云：截断方法\n$3.14159$\n要保留2位小数 → 看前两位小数：$14$\n直接截断后面所有数字', en: 'Zhao Yun: "Truncation method\n$3.14159$\nKeep 2dp → look at first two decimal digits: $14$\nChop off everything after"' }, highlightField: 'ans' },
      { text: { zh: '赵云：执行截断\n$3.14|159$ → 竖线右边全部去掉\n$= 3.14$', en: 'Zhao Yun: "Execute truncation\n$3.14|159$ → remove everything right of the line\n$= 3.14$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：对比四舍五入\n四舍五入到2位：看第3位=$1$，$1<5$，舍。\n结果也是 $3.14$（碰巧一样）\n\n但 $3.14**8** \\to$ 截断=$3.14$，四舍五入=$3.15$', en: 'Zhao Yun: "Compare with rounding\nRound to 2dp: look at 3rd dp = $1$, $1<5$, round down.\nAlso $3.14$ (coincidentally same)\n\nBut $3.14**8** \\to$ truncation=$3.14$, rounding=$3.15$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：答案\n$3.14159$ 截断到2位小数 $= 3.14$', en: 'Zhao Yun: "Answer\n$3.14159$ truncated to 2dp $= 3.14$"' }, highlightField: 'ans' },
      { text: { zh: '赵云：验算\n原数 $3.14159$，截断结果 $3.14$\n误差 $= 3.14159 - 3.14 = 0.00159$（很小）\n截断永远向下偏——知道这个偏差方向很重要！', en: 'Zhao Yun: "Verify\nOriginal $3.14159$, truncated $3.14$\nError $= 3.14159 - 3.14 = 0.00159$ (very small)\nTruncation always biases downward — knowing this bias direction matters!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '截断直接砍掉多余数字（永远向下）；四舍五入看下一位决定方向。两者结果可能不同。', en: 'Truncation chops off extra digits (always rounds down); rounding looks at the next digit. Results may differ.' }, formula: { zh: '截断 $\\leq$ 原数；四舍五入可能 $>$ 原数', en: 'Truncation $\\leq$ original; rounding may be $>$ original' }, tips: [{ zh: '赵云提示：截断永远不进位——简单粗暴但要知道偏差方向！', en: 'Zhao Yun Tip: Truncation never rounds up — simple but know the bias direction!' }] },
    storyConsequence: { correct: { zh: '截断术——3.14精准无误！', en: 'Truncation Technique — 3.14 exactly right!' }, wrong: { zh: '截断出错——药量差之毫厘！', en: 'Truncation wrong — dosage off by a hair!' } }
  },
  {
    id: 799, grade: 7, unitId: 15, order: 2,
    unitTitle: { zh: 'Unit 15: 估算进阶', en: 'Unit 15: Advanced Estimation' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '快速估算', en: 'Quick Estimation' },
    skillName: { zh: '估算计算', en: 'Estimating Calculations' },
    skillSummary: { zh: '把数字四舍五入到方便计算的整数再运算', en: 'Round numbers to convenient values before calculating' },
    story: { zh: '化学家要快速估算浓度：$29.7 \\div 0.98 \\approx ?$', en: 'A chemist needs a quick concentration estimate: $29.7 \\div 0.98 \\approx ?$' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '关羽：简化计算\n$30 \\div 1 = 30$', en: 'Guan Yu: "Simplified calculation\n$30 \\div 1 = 30$"' }, highlightField: 'ans' },
      { text: { zh: '关羽：检查精度\n精确值：$29.7 \\div 0.98 = 30.306...$\n估算值：$30$\n误差约 $1\\%$——非常好的估算！', en: 'Guan Yu: "Check precision\nExact: $29.7 \\div 0.98 = 30.306...$\nEstimate: $30$\nError about $1\\%$ — excellent estimation!"' }, highlightField: 'ans' },
      { text: { zh: '关羽：答案\n$29.7 \\div 0.98 \\approx 30$', en: 'Guan Yu: "Answer\n$29.7 \\div 0.98 \\approx 30$"' }, highlightField: 'ans' },
      { text: { zh: '关羽：验算\n$30 \\times 0.98 = 29.4 \\approx 29.7$ ✓\n反向乘回去接近原数——估算有效！', en: 'Guan Yu: "Verify\n$30 \\times 0.98 = 29.4 \\approx 29.7$ ✓\nMultiply back gives approximately the original — estimation valid!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '估算：把数字简化为好算的整数。除以接近1的数≈原数。关键是选择合适的简化方向。', en: 'Estimation: simplify to easy integers. Dividing by ≈1 gives ≈ the original. Key is choosing the right simplification.' }, formula: { zh: '$29.7 \\div 0.98 \\approx 30 \\div 1 = 30$', en: '$29.7 \\div 0.98 \\approx 30 \\div 1 = 30$' }, tips: [{ zh: '关羽提示：除以0.98≈除以1——接近1的除数别怕，结果几乎不变！', en: 'Guan Yu Tip: Dividing by 0.98 ≈ dividing by 1 — a divisor near 1 barely changes the result!' }] },
    storyConsequence: { correct: { zh: '快速估算——30精准到位！', en: 'Quick Estimation — 30 spot on!' }, wrong: { zh: '估算偏差太大——浓度判断失误！', en: 'Estimation too far off — concentration misjudged!' } }
  },
  {
    id: 800, grade: 7, unitId: 15, order: 3,
    unitTitle: { zh: 'Unit 15: 估算进阶', en: 'Unit 15: Advanced Estimation' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '验算捉错', en: 'Check by Estimation' },
    skillName: { zh: '估算验算', en: 'Checking by Estimation' },
    skillSummary: { zh: '用估算快速检查计算结果是否合理', en: 'Use estimation to quickly check if a calculation result is reasonable' },
    story: { zh: '小明算出 $38.7 \\times 5.12 = 1981.44$。估算检验 $40 \\times 5 = 200$。结果差了10倍吗？(1=没差, 2=差了)', en: 'Xiao Ming calculates $38.7 \\times 5.12 = 1981.44$. Estimation check: $40 \\times 5 = 200$. Is it off by 10x? (1=No, 2=Yes)' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '张飞：比较\n计算结果：$1981.44$\n估算结果：$200$\n$1981.44 \\div 200 \\approx 9.9$——差了约10倍！', en: 'Zhang Fei: "Compare\nCalculated: $1981.44$\nEstimated: $200$\n$1981.44 \\div 200 \\approx 9.9$ — off by ~10x!"' }, highlightField: 'ans' },
      { text: { zh: '张飞：找错误原因\n正确答案：$38.7 \\times 5.12 = 198.144$\n小明写成了 $1981.44$——小数点错了一位！', en: 'Zhang Fei: "Find the error\nCorrect: $38.7 \\times 5.12 = 198.144$\nXiao Ming wrote $1981.44$ — decimal point off by one place!"' }, highlightField: 'ans' },
      { text: { zh: '张飞：答案\n差了10倍——答案是 $2$。', en: 'Zhang Fei: "Answer\nYes, off by 10x — answer is $2$."' }, highlightField: 'ans' },
      { text: { zh: '张飞：验算\n$198.144 \\approx 200$ ✓（与估算吻合）\n$1981.44 \\approx 2000 \\neq 200$ ✗\n\n估算验算就是比较数量级——差了10倍一定有错！', en: 'Zhang Fei: "Verify\n$198.144 \\approx 200$ ✓ (matches estimate)\n$1981.44 \\approx 2000 \\neq 200$ ✗\n\nEstimation checking compares orders of magnitude — 10x off means an error!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '估算验算：先估算一个大概值，再看计算结果是否在同一数量级。差10倍以上一定有错。', en: 'Estimation checking: estimate a rough value first, then see if the calculated result is in the same ballpark. 10x off means an error.' }, formula: { zh: '估算 $\\approx$ 计算结果 → 合理；差10倍 → 有错', en: 'Estimate $\\approx$ calculated → reasonable; 10x off → error' }, tips: [{ zh: '张飞提示：算完必估——小数点错一位就差10倍，估算能救命！', en: 'Zhang Fei Tip: Always estimate after calculating — one decimal place off means 10x error, estimation saves lives!' }] },
    storyConsequence: { correct: { zh: '验算捉错——发现10倍差异！', en: 'Check by Estimation — 10x error caught!' }, wrong: { zh: '没发现数量级差异——危险的疏忽！', en: 'Missed the order of magnitude error — dangerous oversight!' } }
  },
  {
    id: 801, grade: 7, unitId: 15, order: 4,
    unitTitle: { zh: 'Unit 15: 估算进阶', en: 'Unit 15: Advanced Estimation' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '目测长度', en: 'Estimating Lengths' },
    skillName: { zh: '估算长度', en: 'Estimating Lengths' },
    skillSummary: { zh: '用身边的参照物来估算长度', en: 'Use familiar reference objects to estimate lengths' },
    story: { zh: '赵云问：一扇门大约多高？(1=1米, 2=2米, 3=3米)', en: 'Zhao Yun asks: how tall is a door approximately? (1=1m, 2=2m, 3=3m)' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '赵云：分析门高\n$1$ 米太矮——小孩都要弯腰\n$3$ 米太高——那是一层楼高\n$2$ 米——成年人刚好能通过', en: 'Zhao Yun: "Analyse door height\n$1$ m too short — even children would duck\n$3$ m too tall — that\'s a full floor height\n$2$ m — adults just fit through"' }, highlightField: 'ans' },
      { text: { zh: '赵云：用身高验证\n普通成年人身高约 $1.7$ m\n门高需要比人高一些 → $\\approx 2$ m', en: 'Zhao Yun: "Verify with body height\nAverage adult height $\\approx 1.7$ m\nDoor must be taller → $\\approx 2$ m"' }, highlightField: 'ans' },
      { text: { zh: '赵云：答案\n一扇门大约 $2$ 米高。', en: 'Zhao Yun: "Answer\nA door is approximately $2$ metres tall."' }, highlightField: 'ans' },
      { text: { zh: '赵云：验算\n标准门高约 $2.04$ m ≈ $2$ m ✓\n\n记住：估算不求精确，但要在正确的数量级！', en: 'Zhao Yun: "Verify\nStandard door height ≈ $2.04$ m ≈ $2$ m ✓\n\nRemember: estimation doesn\'t need to be exact, just the right order of magnitude!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '估算长度：用身边的参照物（手掌、步长、身高）来判断大小。关键是数量级正确。', en: 'Estimating lengths: use familiar references (palm, stride, height). The key is getting the right order of magnitude.' }, formula: { zh: '门 $\\approx 2$m，一层楼 $\\approx 3$m，手掌 $\\approx 10$cm', en: 'Door $\\approx 2$m, one floor $\\approx 3$m, palm $\\approx 10$cm' }, tips: [{ zh: '赵云提示：记住5个参照物——手指1cm、手掌10cm、步长70cm、门高2m、楼高3m！', en: 'Zhao Yun Tip: Remember 5 references — finger 1cm, palm 10cm, stride 70cm, door 2m, floor 3m!' }] },
    storyConsequence: { correct: { zh: '目测长度——2米精准估算！', en: 'Estimating Lengths — 2m spot on!' }, wrong: { zh: '长度估错了——参照物要记牢！', en: 'Length estimate off — memorise your references!' } }
  },
  {
    id: 802, grade: 7, unitId: 15, order: 5,
    unitTitle: { zh: 'Unit 15: 估算进阶', en: 'Unit 15: Advanced Estimation' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '四舍五入争议', en: 'Rounding Dispute' },
    skillName: { zh: '四舍五入歧义', en: 'Rounding Ambiguity' },
    skillSummary: { zh: '注意"5"的四舍五入规则和可能的歧义', en: 'Watch out for rounding rules with "5" and potential ambiguity' },
    story: { zh: '一个学生得 $4.3$，另一个得 $4.4$。问：$4.35$ 四舍五入到1位小数 = ?', en: 'One student gets $4.3$, another $4.4$. Question: round $4.35$ to 1dp = ?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '刘备：应用到 $4.35$\n保留1位小数 → 看第2位小数 = $5$\n$5 \\geq 5$ → 进位\n$4.3$ → $4.4$', en: 'Liu Bei: "Apply to $4.35$\nKeep 1dp → look at 2nd dp = $5$\n$5 \\geq 5$ → round up\n$4.3$ → $4.4$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：为什么 $5$ 要进位？\n$0-4$ 有5个数，$5-9$ 也有5个数。如果5不进位，"舍"就有6个数（$0-5$），不公平！\n$5$ 归入"入"让上下各5个，最公平。', en: 'Liu Bei: "Why does 5 round up?\n0-4 has 5 digits, 5-9 has 5 digits. If 5 doesn\'t round up, \'down\' would have 6 digits (0-5) — unfair!\nPutting 5 with \'up\' makes it 5 each way — most fair."' }, highlightField: 'ans' },
      { text: { zh: '刘备：答案\n$4.35$ 四舍五入到1位小数 $= 4.4$', en: 'Liu Bei: "Answer\n$4.35$ rounded to 1dp $= 4.4$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：验算\n$4.35$ 到 $4.4$ 的距离 $= 0.05$\n$4.35$ 到 $4.3$ 的距离 $= 0.05$\n距离相等时，规则说"入"→ $4.4$ ✓', en: 'Liu Bei: "Verify\nDistance from $4.35$ to $4.4$ $= 0.05$\nDistance from $4.35$ to $4.3$ $= 0.05$\nEqual distance — rule says round UP → $4.4$ ✓"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '四舍五入中"5"归入"入"。遇到5就进位是标准规则，不是"五舍六入"。', en: 'In rounding, "5" rounds UP. Rounding up at 5 is the standard rule, not "round down at 5".' }, formula: { zh: '$\\geq 5$ 进位，$< 5$ 舍去', en: '$\\geq 5$ round up, $< 5$ round down' }, tips: [{ zh: '刘备提示：遇到5一律进位——这是考试标准答案的规则！', en: 'Liu Bei Tip: Always round up at 5 — this is the standard exam rule!' }] },
    storyConsequence: { correct: { zh: '四舍五入争议——4.4才是正解！', en: 'Rounding Dispute — 4.4 is correct!' }, wrong: { zh: '四舍五入规则记混了——5要进位！', en: 'Rounding rule confused — 5 rounds up!' } }
  },
  // --- Year 7 Unit 16: 比例进阶 (Topic 1.11) ---
  {
    id: 803, grade: 7, unitId: 16, order: 1,
    unitTitle: { zh: 'Unit 16: 比例进阶', en: 'Unit 16: Advanced Ratios' },
    topic: 'Algebra', type: 'RATIO',
    title: { zh: '救援通道', en: 'Rescue Tunnel' },
    discoverSteps: [{
      prompt: { zh: '4台机器12小时能挖通隧道。但洪水3小时就来了！\n机器越多，时间越短——这叫"反比例"。\n\n要3小时挖通，需要几台机器？', en: '4 machines dig a tunnel in 12 hours. But the flood arrives in 3 hours!\nMore machines = less time — this is "inverse proportion".\n\nTo finish in 3 hours, how many machines needed?' },
      type: 'choice' as const,
      choices: [
        { zh: '16台（$4 \\times 12 \\div 3 = 16$）', en: '16 ($4 \\times 12 \\div 3 = 16$)' },
        { zh: '1台（$4 \\times 3 \\div 12 = 1$）', en: '1 ($4 \\times 3 \\div 12 = 1$)' },
      ],
      onCorrect: { zh: '对！反比例的关键：总工作量不变。$4 \\times 12 = 48$ 机器·小时。$48 \\div 3 = 16$ 台机器。', en: 'Right! Key to inverse proportion: total work stays the same. $4 \\times 12 = 48$ machine-hours. $48 \\div 3 = 16$ machines.' },
      onWrong: { zh: '反了！机器越多时间越短，不是越少。总工作量 $= 4 \\times 12 = 48$。$48 \\div 3 = 16$ 台。', en: 'Backwards! More machines = less time, not fewer. Total work $= 4 \\times 12 = 48$. $48 \\div 3 = 16$ machines.' },
      onSkip: { zh: '反比例：一个增大，另一个减小，乘积不变。\n$4 \\times 12 = 48$（总工作量）\n$48 \\div 3 = 16$ 台机器。', en: 'Inverse proportion: one increases, the other decreases, product stays constant.\n$4 \\times 12 = 48$ (total work)\n$48 \\div 3 = 16$ machines.' },
    }],
    skillName: { zh: '反比例', en: 'Inverse Proportion' },
    skillSummary: { zh: '反比例：一个量增大，另一个等比缩小，乘积不变', en: 'Inverse proportion: one increases, the other decreases proportionally, product constant' },
    story: { zh: '救援通道：$4$ 台机器 $12$ 小时挖通。要 $3$ 小时内完成，需要几台？', en: 'Rescue tunnel: 4 machines take 12 hours. To finish in 3 hours, how many machines?' },
    description: { zh: '$4$ 台机器 $12$ 小时。$3$ 小时需要几台？', en: '4 machines, 12 hours. How many for 3 hours?' },
    data: { answer: 16 }, difficulty: 'Medium', reward: 45,
    kpId: 'kp-1.11-03', sectionId: 'number',
    tutorialSteps: [
      { text: { zh: '刘备：为什么要学反比例？\n救援通道4台机器12小时，但洪水3小时就来！机器越多越快——这就是反比例。正比例是"同增同减"，反比例是"一增一减"。紧急情况下的资源调度全靠它！', en: 'Liu Bei: "Why learn inverse proportion?\nRescue tunnel: 4 machines, 12 hours, but flood in 3! More machines = faster — that\'s inverse proportion. Direct is \'both increase\'; inverse is \'one up, one down\'. Emergency resource planning depends on this!"' }, highlightField: 'ans' },
      { text: { zh: '刘备：反比例公式\n$x \\times y = k$（乘积恒定）\n\n机器数 × 时间 = 总工作量\n$4 \\times 12 = 48$', en: 'Liu Bei: "Inverse proportion formula\n$x \\times y = k$ (product is constant)\n\nMachines × Time = Total work\n$4 \\times 12 = 48$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：求新的机器数\n$n \\times 3 = 48$\n$n = 48 \\div 3 = 16$', en: 'Liu Bei: "Find the new number of machines\n$n \\times 3 = 48$\n$n = 48 \\div 3 = 16$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：理解倍数关系\n时间从12减到3 → 缩小4倍\n机器数必须增大4倍：$4 \\times 4 = 16$', en: 'Liu Bei: "Understand the scale\nTime from 12 to 3 → reduced by 4x\nMachines must increase by 4x: $4 \\times 4 = 16$"' }, highlightField: 'ans' },
      { text: { zh: '刘备：答案\n需要 $16$ 台机器。', en: 'Liu Bei: "Answer\n$16$ machines needed."' }, highlightField: 'ans' },
      { text: { zh: '刘备：验算\n$16 \\times 3 = 48 = 4 \\times 12$ ✓\n乘积不变——反比例关系验证成功！', en: 'Liu Bei: "Verify\n$16 \\times 3 = 48 = 4 \\times 12$ ✓\nProduct unchanged — inverse proportion confirmed!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '反比例：两个量的乘积恒定。一个变为原来的n倍，另一个变为1/n倍。', en: 'Inverse proportion: the product of two quantities is constant. One becomes n times, the other becomes 1/n times.' }, formula: { zh: '$x_1 \\times y_1 = x_2 \\times y_2 = k$', en: '$x_1 \\times y_1 = x_2 \\times y_2 = k$' }, tips: [{ zh: '刘备提示：正比同增减，反比积不变——记住这两个特征！', en: 'Liu Bei Tip: Direct = both change together; Inverse = product stays the same — remember these two features!' }] },
    storyConsequence: { correct: { zh: '救援通道——16台机器3小时搞定！', en: 'Rescue Tunnel — 16 machines in 3 hours!' }, wrong: { zh: '机器数算错——洪水来不及了！', en: 'Machine count wrong — flood arrived too soon!' } }
  },
  {
    id: 804, grade: 7, unitId: 16, order: 2,
    unitTitle: { zh: 'Unit 16: 比例进阶', en: 'Unit 16: Advanced Ratios' },
    topic: 'Algebra', type: 'ESTIMATION',
    title: { zh: '地图测距', en: 'Map Distance' },
    skillName: { zh: '地图比例尺', en: 'Map Scales' },
    skillSummary: { zh: '比例尺 = 地图距离:实际距离', en: 'Scale = map distance : actual distance' },
    story: { zh: '地图比例尺 $1:50000$，两城在地图上相距 $3$ cm。实际距离多少 km？', en: 'Map scale $1:50000$, two cities are $3$ cm apart on the map. Actual distance in km?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '关羽：计算实际距离\n地图距离 $= 3$ cm\n实际距离 $= 3 \\times 50000 = 150000$ cm', en: 'Guan Yu: "Calculate actual distance\nMap distance $= 3$ cm\nActual distance $= 3 \\times 50000 = 150000$ cm"' }, highlightField: 'ans' },
      { text: { zh: '关羽：单位换算\n$150000$ cm $\\div 100 = 1500$ m\n$1500$ m $\\div 1000 = 1.5$ km', en: 'Guan Yu: "Unit conversion\n$150000$ cm $\\div 100 = 1500$ m\n$1500$ m $\\div 1000 = 1.5$ km"' }, highlightField: 'ans' },
      { text: { zh: '关羽：答案\n实际距离 $= 1.5$ km', en: 'Guan Yu: "Answer\nActual distance $= 1.5$ km"' }, highlightField: 'ans' },
      { text: { zh: '关羽：验算\n$1.5$ km $= 150000$ cm\n$150000 \\div 50000 = 3$ cm（地图距离）✓\n\n快捷法：$1:50000$ → $1$ cm $= 0.5$ km → $3$ cm $= 1.5$ km', en: 'Guan Yu: "Verify\n$1.5$ km $= 150000$ cm\n$150000 \\div 50000 = 3$ cm (map distance) ✓\n\nShortcut: $1:50000$ → $1$ cm $= 0.5$ km → $3$ cm $= 1.5$ km"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '比例尺把地图距离翻译成实际距离。关键步骤：乘以比例尺，再做单位换算。', en: 'Map scale translates map distance to actual distance. Key steps: multiply by scale factor, then convert units.' }, formula: { zh: '实际距离 $=$ 地图距离 $\\times$ 比例尺分母', en: 'Actual distance $=$ map distance $\\times$ scale denominator' }, tips: [{ zh: '关羽提示：1:50000中1cm=0.5km——记住这个快捷换算！', en: 'Guan Yu Tip: In 1:50000, 1cm = 0.5km — remember this quick conversion!' }] },
    storyConsequence: { correct: { zh: '地图测距——1.5km精准定位！', en: 'Map Distance — 1.5km precisely located!' }, wrong: { zh: '比例尺算错——距离判断失误！', en: 'Scale error — distance misjudged!' } }
  },
  {
    id: 805, grade: 7, unitId: 16, order: 3,
    unitTitle: { zh: 'Unit 16: 比例进阶', en: 'Unit 16: Advanced Ratios' },
    topic: 'Algebra', type: 'RATIO',
    title: { zh: '公平分金', en: 'Fair Gold Split' },
    skillName: { zh: '按比例分配', en: 'Ratio Sharing' },
    skillSummary: { zh: '按比例分配：先求总份数，再算每份的值', en: 'Ratio sharing: find total parts first, then value per part' },
    story: { zh: '两位朋友按 $2:3$ 分 $100$ 元。多的那份是多少？', en: 'Two friends split $100 in ratio $2:3$. How much is the larger share?' },
    ...
    tutorialSteps: [
      ...
      { text: { zh: '张飞：计算各自份额\n第一人：$2 \\times 20 = 40$ 元\n第二人：$3 \\times 20 = 60$ 元', en: 'Zhang Fei: "Calculate each share\nPerson 1: $2 \\times 20 = 40$\nPerson 2: $3 \\times 20 = 60$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：或用分数法\n第二人占 $\\frac{3}{5}$\n$\\frac{3}{5} \\times 100 = 60$', en: 'Zhang Fei: "Or use the fraction method\nPerson 2 gets $\\frac{3}{5}$\n$\\frac{3}{5} \\times 100 = 60$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：答案\n多的那份 $= 60$ 元', en: 'Zhang Fei: "Answer\nLarger share $= 60$"' }, highlightField: 'ans' },
      { text: { zh: '张飞：验算\n$40 + 60 = 100$ ✓（总数对）\n$40 : 60 = 2 : 3$ ✓（比例对）\n两个都要验——总数和比例都正确才算对！', en: 'Zhang Fei: "Verify\n$40 + 60 = 100$ ✓ (total correct)\n$40 : 60 = 2 : 3$ ✓ (ratio correct)\nCheck both — total AND ratio must be right!"' }, highlightField: 'ans' },
    ],
    secret: { concept: { zh: '按比例分配：总份数→每份的值→各自份额。可以用"份数法"或"分数法"两种方式。', en: 'Ratio sharing: total parts → value per part → each share. Use either the "parts method" or "fraction method".' }, formula: { zh: '份额 $= \\frac{\\text{自己的份数}}{\\text{总份数}} \\times $ 总量', en: 'Share $= \\frac{\\text{own parts}}{\\text{total parts}} \\times$ total' }, tips: [{ zh: '张飞提示：验算要查两个——总数对不对，比例对不对！', en: 'Zhang Fei Tip: Verify two things — is the total correct, and is the ratio correct!' }] },
    storyConsequence: { correct: { zh: '公平分金——60元精准分配！', en: 'Fair Gold Split — 60 perfectly allocated!' }, wrong: { zh: '比例分错了——有人多拿了！', en: 'Ratio wrong — someone got too much!' } }
  },
];
