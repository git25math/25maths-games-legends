...
export const MISSIONS_Y9: Mission[] = [
  ...
  },
  {
    ...
    discoverSteps: [
      {
        prompt: { zh: '3, 4, 5 这三个数有什么特别的关系？\n\n提示：试试把每个数平方（乘以自己），看看有没有规律。\n$3^2 = 9$，$4^2 = 16$，$5^2 = 25$', en: '3, 4, 5 — these three numbers have a special relationship.\n\nHint: try squaring each (multiply by itself):\n$3^2 = 9$, $4^2 = 16$, $5^2 = 25$' },
        type: 'choice',
        choices: [
          { zh: '$9 + 16 = 25$！前两个的平方加起来等于第三个的平方', en: '$9 + 16 = 25$! The first two squares add up to the third' },
          { zh: '它们是连续的数', en: 'They are consecutive numbers' },
          { zh: '看不出来', en: 'I don\'t see it' },
        ],
        acceptPattern: '',
        onCorrect: { zh: '你发现了勾股定理的核心！\n$3^2 + 4^2 = 5^2$\n$9 + 16 = 25$ ✓\n\n在直角三角形里，两条短边的平方之和 = 最长边（斜边）的平方。\n这个规律 2500 年前就被发现了，至今是几何里最重要的公式之一。', en: 'You discovered the heart of the Pythagorean theorem!\n$3^2 + 4^2 = 5^2$\n$9 + 16 = 25$ ✓\n\nIn a right triangle, the squares of the two short sides add up to the square of the longest side (hypotenuse).\nThis pattern was found 2500 years ago and remains one of the most important formulas in geometry.' },
        onWrong: { zh: '再看一下这三个平方数：$9, 16, 25$。\n$9 + 16 = 25$！\n也就是说：$3^2 + 4^2 = 5^2$。\n\n这就是勾股定理：直角三角形中，$a^2 + b^2 = c^2$。', en: 'Look at the three squares again: $9, 16, 25$.\n$9 + 16 = 25$!\nThat means: $3^2 + 4^2 = 5^2$.\n\nThis is the Pythagorean theorem: in a right triangle, $a^2 + b^2 = c^2$.' },
        onSkip: { zh: '我来揭晓：$3^2 + 4^2 = 9 + 16 = 25 = 5^2$！\n两个小数的平方加起来，恰好等于大数的平方。\n\n这就是"勾股定理"：$a^2 + b^2 = c^2$。\n只要是直角三角形，三条边永远满足这个关系。', en: 'Let me reveal it: $3^2 + 4^2 = 9 + 16 = 25 = 5^2$!\nThe two smaller squares add up exactly to the larger square.\n\nThis is the Pythagorean theorem: $a^2 + b^2 = c^2$.\nEvery right triangle follows this relationship.' },
      },
      {
