    ...
    discoverSteps: [
      {
        ...
        acceptPattern: '',
        onCorrect: { zh: '你找到了最大的那个！\n$6x = 6 \\times x$\n$12 = 6 \\times 2$\n\n它们共同的"最大因数"就是 6。\n因式分解就是把这个 6 从两项中"提"出来——像拆快递，把共同的外包装拆掉。', en: 'You found the biggest one!\n$6x = 6 \\times x$\n$12 = 6 \\times 2$\n\nTheir largest shared factor is 6.\nFactorising means pulling that 6 out of both — like unwrapping a shared package.' },
        onWrong: { zh: '被 2 整除没错，但还有更大的！\n$6x = 6 \\times x$（6 能整除）\n$12 = 6 \\times 2$（6 也能整除）\n\n6 才是最大公因数。因式分解要找**最大**的那个。', en: 'Divisible by 2 is true, but there\'s a bigger one!\n$6x = 6 \\times x$ (6 divides in)\n$12 = 6 \\times 2$ (6 divides in too)\n\n6 is the biggest common factor. Factorising needs the BIGGEST one.' },
        onSkip: { zh: '我来拆给你看：\n$6x$ 里面有 $6$（$6 \\times x$）\n$12$ 里面也有 $6$（$6 \\times 2$）\n\n它们都有 6！这个 6 就是"公因数"。\n因式分解 = 把公因数提到外面。', en: 'Let me break them open:\n$6x$ contains $6$ ($6 \\times x$)\n$12$ also contains $6$ ($6 \\times 2$)\n\nBoth have 6! That\'s the "common factor".\nFactorising = pull the common factor outside.' },
      },
      {
        ...
        acceptPattern: '',
        onCorrect: { zh: '完美！$6x + 12 = 6(x + 2)$\n\n你刚才做了因式分解——就两步：\n① 找到公因数（6）\n② 每项除以它，剩下的放进括号（$x + 2$）\n\n就这样！接下来我们练更多。', en: 'Perfect! $6x + 12 = 6(x + 2)$\n\nYou just factorised — just two steps:\n① Find the common factor (6)\n② Divide each term by it, put the rest in brackets ($x + 2$)\n\nThat\'s it! Let\'s practise more.' },
        onWrong: { zh: '我们已经算了：$6x ÷ 6 = x$，$12 ÷ 6 = 2$。\n所以括号里是 $x + 2$，不是其他。\n\n$6x + 12 = 6(x + 2)$\n\n检验：$6 \\times x + 6 \\times 2 = 6x + 12$ ✓ 完美还原！', en: 'We already calculated: $6x ÷ 6 = x$, $12 ÷ 6 = 2$.\nSo the bracket contains $x + 2$, nothing else.\n\n$6x + 12 = 6(x + 2)$\n\nCheck: $6 \\times x + 6 \\times 2 = 6x + 12$ ✓ Perfectly restored!' },
        onSkip: { zh: '已经告诉你了：$6x ÷ 6 = x$，$12 ÷ 6 = 2$。\n所以：$6x + 12 = 6(x + 2)$\n\n因式分解就是：\n① 找公因数 → ② 除出来放括号\n展开括号能还原 = 验算通过！', en: 'We told you: $6x ÷ 6 = x$, $12 ÷ 6 = 2$.\nSo: $6x + 12 = 6(x + 2)$\n\nFactorising is:\n① Find common factor → ② Divide out into brackets\nExpanding brackets gives back the original = verified!' },
      },
    ],
