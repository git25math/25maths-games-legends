...
export const MISSIONS_Y11: Mission[] = [
  ...
  },
  {
    ...
    tutorialSteps: [
      ...
      { text: { zh: '诸葛亮：极值的秘密\n山峰和山谷——在顶点和底部，坡度都为零。\n$f\'(x) = 0$ 就是"坡度为零"的数学表达。\n但零坡度不一定是极值，还需要二阶导来裁判。', en: 'Zhuge Liang: "The secret of extrema\nPeaks and valleys — at the top and bottom, the slope is zero.\n$f\'(x) = 0$ means \'zero slope\' mathematically.\nBut zero slope isn\'t always an extremum — we need the second derivative to judge."' }, highlightField: 'x' },
