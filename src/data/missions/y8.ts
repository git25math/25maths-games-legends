...
export const MISSIONS_Y8: Mission[] = [
  ...
  },
  {
    ...
    tutorialSteps: [
      ...
      { text: { zh: '诸葛亮：计算\n两个小数相乘。', en: 'Zhuge Liang: "计算\n两个小数相乘."' }, highlightField: 'p' },
      { text: { zh: '诸葛亮：答案\n双重情报同时准确的概率确定！', en: 'Zhuge Liang: "答案\n双重情报同时准确的概率确定!"' }, highlightField: 'p' },
      { text: { zh: '诸葛亮：验算\n$P(A \\cap B) < P(A)$？两件事同时发生应该更难 ✓', en: 'Zhuge Liang: "验算\n$P(A \\cap B) < P(A)$?两件事同时发生应该更难 ✓"' }, highlightField: 'p' },
    ],
