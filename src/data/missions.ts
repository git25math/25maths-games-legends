...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '贾诩：什么是平行线？\n想象两条永远不会交叉的路——无论延伸多远，间距始终相同。\n在数学中，平行线的标志就是**斜率完全相等**！', en: 'Jia Xu: "What are parallel lines?\nImagine two roads that never cross — no matter how far they extend, the gap stays the same.\nIn math, the sign of parallel lines is **exactly equal gradients**!"' }, highlightField: 'm' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '贾诩：什么是 $y$ 截距？\n$y$ 截距就是直线穿过 $y$ 轴的那个点——此时 $x = 0$。\n在这道题里，它就是补给线的**出发渡口位置**。', en: 'Jia Xu: "What is the y-intercept?\nThe y-intercept is where the line crosses the y-axis — where $x = 0$.\nIn this problem, it\'s the **starting ferry position** of the supply line."' }, highlightField: 'c' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '贾诩：什么是中点？\n两个据点之间正正好好的中间位置。\n不偏左也不偏右，不偏上也不偏下——绝对公平的会合点。', en: 'Jia Xu: "What is a midpoint?\nThe exact middle between two positions.\nNot too far left or right, not too high or low — the perfectly fair meeting point."' }, highlightField: 'x' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '荀彧：因式分解是什么？\n展开的反操作——把散装物资重新打包成"每队一份"。\n找到公因子，就知道能分成多少队！', en: 'Xun Yu: "What is factorising?\nThe reverse of expanding — rebundle loose supplies into squad packs.\nFind the common factor = how many squads!"' }, highlightField: 'ans' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '荀彧：什么是不等式？\n不等式就是"不能少于"或"不能超过"的约束条件。\n粮草至少要够 15 天——这就是一个不等式！', en: 'Xun Yu: "What is an inequality?\nAn inequality sets a \'must not be less than\' or \'must not exceed\' constraint.\nSupplies must last at least 15 days — that\'s an inequality!"' }, highlightField: 'ans' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '关羽：什么是平行线截角？\n两条永不相交的线（平行线）被第三条线（截线）切过时，会产生特殊的角度关系。\n这些关系就是解题的"秘密武器"！', en: 'Guan Yu: "What are parallel line angles?\nWhen two never-crossing lines (parallel) are cut by a third line (transversal), special angle relationships appear.\nThese relationships are the \'secret weapon\' for solving!"' }, highlightField: 'x' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '赵云：多边形内角和公式\n$$\\text{内角和} = (n - 2) \\times 180°$$\n$n$ = 边数。三角形 $(3-2)×180=180°$，四边形 $(4-2)×180=360°$...', en: 'Zhao Yun: "Polygon interior angle sum\n$$\\text{Sum} = (n - 2) \\times 180°$$\n$n$ = number of sides. Triangle $(3-2)×180=180°$, quadrilateral $(4-2)×180=360°$..."' }, highlightField: 'x' },
  ...
  // --- Year 9 Unit 9: March Speed & Percentages ---
  {
    ...
    kpId: 'kp-1.12-02', sectionId: 'number',
    tutorialSteps: [
      { text: { zh: '赵云：速度、距离、时间\n这三个量的关系是：$$速度 = \\frac{距离}{时间}$$\n记住三角形口诀：D 在上，S 和 T 在下。\n遮住要求的量，剩下的就是公式！', en: 'Zhao Yun: "Speed, distance, time\nThe relationship: $$\\text{Speed} = \\frac{\\text{Distance}}{\\text{Time}}$$\nRemember the triangle: D on top, S and T below.\nCover what you need — the rest is the formula!"' }, highlightField: 'x' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '曹操：百分比增减——快速算出变化后的值\n增长 $20\\%$ = 原来的 $120\\%$ = 原来 × $1.2$\n减少 $20\\%$ = 原来的 $80\\%$ = 原来 × $0.8$', en: 'Cao Cao: "Percentage change — quickly find the new value\nIncrease 20% = 120% of original = original × 1.2\nDecrease 20% = 80% of original = original × 0.8"' }, highlightField: 'ans' },
  ...
  },
  {
    ...
    tutorialSteps: [
      { text: { zh: '曹操：反向百分比——"逆向推理"\n知道结果反推原值。这是很多学生觉得难的题型，但其实只需要"除一下"！\n增加 $25\\%$ 后变成 $625$ → 原值 = $\\frac{625}{1.25}$', en: 'Cao Cao: "Reverse percentage — \'backward reasoning\'\nKnow the result, find the original. Students find this hard, but it\'s just one division!\nAfter 25% increase it\'s 625 → original = $\\frac{625}{1.25}$"' }, highlightField: 'ans' },
