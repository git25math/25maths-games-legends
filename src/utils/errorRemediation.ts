...
const TOPIC_REMEDIATION: Record<string, ErrorRemediationMap> = {
  ...
  // 4.7 = Circle theorems (kp-registry: 4.7)
  '4.7': {
    magnitude: [
    ...
    method:    [
      ...
      { topicId: '4.4', reason: { zh: '相似图形识别', en: 'Similar shape identification' } },
    ],
    unknown:   [{ topicId: '4.6', reason: { zh: '角度基础', en: 'Angle fundamentals' } }],
  },
  // 4.8 = Constructions and loci (kp-registry: 4.8)
  '4.8': {
    method:    [
      { topicId: '4.2', reason: { zh: '基础几何作图', en: 'Basic geometrical constructions' } },
      { topicId: '4.6', reason: { zh: '角度关系（角平分线/垂直平分线）', en: 'Angle relationships (bisectors/perpendicular bisectors)' } },
    ],
    magnitude: [{ topicId: '5.1', reason: { zh: '距离与长度单位', en: 'Distance and length units' } }],
  },
