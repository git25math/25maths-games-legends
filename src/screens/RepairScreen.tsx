...
import { getPattern, getPatternsForTopic } from '../utils/errorPatterns';
import { getTopicInfo } from '../utils/techTree';
import type { SkillHealthState } from '../utils/processAttempt';
import { processRecoveryComplete } from '../utils/processAttempt';
